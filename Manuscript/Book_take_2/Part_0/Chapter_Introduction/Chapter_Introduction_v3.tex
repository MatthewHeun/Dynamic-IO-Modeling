...
And, what phenomena should we be accounting (what data should we be collecting)?
...
\begin{itemize}
	...
	\item{allows accumulation of energy embodied within the economy, and}
	\item{provides metrics that link energy and economic value.}
\end{itemize}
