...
in a way that informs meaningful economic discussion and
leads to enlightened natural resource and energy policy.
Whether or not you think this is a problem depends, in large part, on 
your view of connections between the economy and the biosphere,
your understanding of the material and energy basis for the real economy,
...
whether you think the materials and energy upon which the world currently depends
	can be easility substituted,
whether you think that the world's economies have exeeded 
	the biosphere's waste assimilation capacity, and
whether you think that accounting and information dissemination 
	can lead to changed behaviors.
In short, whether or not you think that inadequate accounting of natural assets 
(especially materials and energy) as they flow through economies is a problem 
depends on whether or not you think there is a problem, in the first place.

We contend that there \emph{is} a problem; 
or, to be precise, significant problem\emph{s} 
that are insidiously nested amongst each other.
Looking ahead, there is ample evidence that the world is facing 
impending material and energy transformations.
...
Of course, if you think that the economy is disconnected from the biosphere,
none of the above challenges will seem important. 
Nor will the argument that we need to keep better track of this stuff be convincing.



Supply scarcity relative to demand (inflows)
   Economies are exceeding assimilative capacity of biosphere (outflows)
   High levels of capital stock require significant maintenance flows (we’re running in place)
   How will transitions and transformations unfold?


**** Discuss energy transformation here ****

Either these transformations will happen to us or we will plan for them.
We believe that planning is preferred.
...
We believe that economies are society's metabolism, and, as such,
are intimately connected to the biosphere upon which they depend for 
material resources, energy, and assimilation of waste. 
Furthermore, there is ample evidence that society'

Some have called it the polycrisis.
...
the twin crises of material and energy depletion, and
whether you 



and on whether you think that knowledge  


In other words, 


links between the   think this is a problem depends on 

And, if we are to do a

That question seems especially pertinent 
