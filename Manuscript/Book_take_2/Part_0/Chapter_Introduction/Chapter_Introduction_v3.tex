...
\begin{itemize}
	...
	\item{embodies energy in material stocks.}\footnote{**** Talk 
			about the ``ideas lying around'' in this footnote? ****}
\end{itemize}
...
Our suggestion for an apt metaphor for the economy (a metabolism)
gives rise to the question ``what types of models does it inform?''

Before developing our models, we can ask the question
...
\begin{itemize}
	...
	\item{compatible with existing systems of national accounts.}
\end{itemize}
...
Finally, we should use the economic sector for our level of analysis.
Doing so allows results from the thermodynamic models to be 
integrated with and compared against existing systems of national accounts
(the sixth item above).
...
If we are to employ thermodynamic accounting equations 
at the level of economic sectors, 
what should we be counting?
We propose to count the following:
