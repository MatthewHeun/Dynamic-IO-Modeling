...
Whether or not you think this is a problem depends, in part, on 
...
and if there are few substitues for the fossil fuels (especially oil)
upon which our economies depend today,
...
We need to know the existing materials and energy structure of our economy. 
...
In short, we need to be \emph{accounting for the environment}!\footnote{The title 
	...
	Third, we should develop our system of national accounts 
		...
		that a healthy environment is able to sustain a healthy economy.
		(In this sense, accounting is a verb with a telos.)
}

But, we also need to know where things are likely to go in the future.
...
the impending energy transformation.
...
for how to account for the environment if we are to plan 
for the impending materials and energy transformation.
...
Nor will need to account for the environment be convincing.
But, in fact, our collective imagination appears to be 
stuck on a view of the economy as a smoothly-running machine 
that is isolated from the biosphere.
