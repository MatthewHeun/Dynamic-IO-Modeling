...
Firstly, our models tell us what aspects of the world
...
value are \emph{valuable} and that those 
that have no value are \emph{worthless}.
...
interact with reality in the manner 
with which we interact with the objects of our
metaphors.\footnote{This is referred to
as \emph{reification}; the making (\emph{facere}, Latin) real of
something (\emph{res}, Latin) that is merely an idea.
Alfred Whitehous refers to this as
