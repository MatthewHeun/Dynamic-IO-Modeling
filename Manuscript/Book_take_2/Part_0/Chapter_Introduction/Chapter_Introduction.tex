...
\includegraphics[width=\linewidth]{Part_0/Chapter_Introduction/images/fig01worldliquidssupplyaug2012.png}
\caption[Oil prices and production]{Oil prices and production.
\url{http://fractionalflow.files.wordpress.com/2012/12/fig01worldliquidssupplyaug2012.png}}
...
is only 0.04.
	\footnote{That is, a 1\% change in the price of oil will only generate a 0.04\% 	increase in supply. 
A price elasticity of .04 is extremely inelastic. For comparison, agricultural output is also considered fairly price inelastic in the short-run as well. 
	Pandey, et al. estimate the short-run (2-year) elasticity of supply of agricultural output in Australia to be around .30.\cite[p. 215]{pandey1982}
	}
