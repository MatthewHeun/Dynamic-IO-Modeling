...
After settling on a new metaphor for the economy 
and after deciding to employ transient thermodynamic equations to develop our model, 
are we any further ahead?  
We think so.
We have chosen to focus on the same system that
systems of national accounts captures.The economy is
disaggregated because that is the locus of our interest. The
biosphere is included in the model, but at an aggregated level. This means that
several important issues are outside of the scope of our new model. For example, questions of
bio-diversity remain outside of this system. An ecologist might have a different
focus. \footnote{Alternative systems can be employed, such as....}
