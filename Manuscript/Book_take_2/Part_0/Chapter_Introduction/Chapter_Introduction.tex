...
The twin dictates [**** challenges? ****] of climate change and 
...
And there is good reason to believe that the earth 
...
has appeared (materialized),
with the promise that we can continue to grow our economies
while reducing our impact on the environment.\cite{Bernardini1993, Wernick1996, Cleveland1998}
Our increasing knowledge and use of technology will
allow us to reduce the material consumption of 
our goods and services.
To achieve such a dematerialization 
...
\noindent{\large \textbf{\emph{Feedback loops}}}\\\\
