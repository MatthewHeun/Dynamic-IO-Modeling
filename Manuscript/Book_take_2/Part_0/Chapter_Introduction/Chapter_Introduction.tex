...
to teach ourselves about our world.
...
to important drivers of real economic change **** growth? **** 
what are the ``important drivers of real economic X'' that we want to include? ****.
This book is an attempt to rectify that undervaluation.
...
**** OK. I think I've identified my reluctance about the treadmill.
I'm wary of including the treadmill of production here, because
it opens a can of worms about substitution of machines for humans,
and that's a distraction from our main point.
Furthermore, we talk about substitution (although not about the machine for human substitution)
in the next subsection. 
I would rather go back to the economic and physical arguments 
for extraction limits. 
Would that be OK?
Perhaps there is space for the treadmill of production in the materials chapter?
MKH
****

Schnaiberg~\cite{schnaiberg1980} introduced the concept of 
the ``treadmill of production'' to describe the systemic process of
ever-increasing capital investment inherent in capitalist society.
...
This is happening in the oil markets.
...
**** If we discuss the wager here, 
I suggest a footnote to the first paragraph (the one about the economic argument).
MKH
****
...
and 
dirty\footnote{Coal, petroleum, natural gas, and other gasses}
...
So, it is often natural systems that must bear the weight of human production.
...
Many wastes, especially airborne pollution, 
...
how accurate is the machine model?
...
informs models in which the economy is closed to the biosphere,
