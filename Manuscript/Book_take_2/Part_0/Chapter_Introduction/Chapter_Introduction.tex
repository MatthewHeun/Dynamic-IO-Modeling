...
thus violates the First Law of Thermodynamics\index{First Law of Thermodynamics}---the 
...
any entropy,
in violation of the Second Law of Thermodynamics\index{Second Law of Thermodynamics}.
...
Input-output analysis, developed by Wassilly Leontief\index{Leontief} in the 1930s 
...
in capital stock\index{accumulation!of capital}
...
net energy analysis (NEA)\index{NEA} to extend 
the traditional Leontief\index{Leontief}
input-output method\index{input-output method} to include important 
energy flows from the environment, 
developing an energy input-output (EI-O)\index{energy input-output}
...
While the Leontief\index{Leontief} input-output method\index{input-output method} 
relies exclusively 
...
(NAICS)\index{North American Industry Classification System} that the 
Bureau of Economic Analysis (BEA)\index{Bureau of Economic Analysis} uses to track economic information[Table B, p.~25].\cite{Lawson2002}
...
Both the original Leontief\index{Leontief} input-output method\index{input-output method} 
...
Thus, there is no accumulation of economic factors\index{accumulation!of economic factors} 
or embodied energy\index{accumulation!of embodied energy} 
within any of the sectors. 
The analysis techniques provide ``snapshots'' 
of economic activity at an instant in time.

Assuming no accumulation of materials\index{accumulation!of materials}, 
...
and the accumulation of materials\index{accumulation!of materials} surrounds us. 
Furthermore, 
...
and embodied energy\index{accumulation!of embodied energy} 
...
models that neglect accumulation\index{accumulation!of materials} 
fail to explain 
...
When accumulation\index{accumulation} is not accounted for,
...
be able to account accumulation\index{accumulation} within the economy.
...
to account for accumulation of goods\index{accumulation!of goods}
and embodied energy\index{accumulation!of embodied energy}. 
