...
\begin{itemize}
	...
	\item{Boulding (1945), pp.2-3 are fantastic! Consumption is the real cost of living in a physical
	...
	\item{Odum (1969) highlights the difference between growing and stable ecosystems.}
		\begin{itemize}
		...
		\end{itemize}
	\item{Daly (2002): \emph{efficient} causes (land, capital, labor) vs. \emph{material} causes (resources).
