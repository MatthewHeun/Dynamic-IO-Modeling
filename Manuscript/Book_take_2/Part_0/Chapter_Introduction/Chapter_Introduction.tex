...
framework as depicted in Figure~\ref{fig:basic_unit}B.\cite{Carter1974,
Bullard1975,Bullard1976a,Herendeen1978,Costanza:1980ww,
Casler1984,Joshi:1999uw,Suh2009}
While the \gls{leontief} \gls{i-o} approach relies exclusively 
...
that the \gls{bea} uses to track economic information[Table B, p.~25].\cite{Lawson2002}
