...
They tell us that wastes are quantitatively unimportant, effectively assuming that the biosphere
...
(through prices and the market mechanism) are enought to effciently guide any transition
to the next outcome.
...
If we extend Figures~\ref{fig:perp_motion_1} and~\ref{fig:perp_motion_2}
...
editing around if needed. *** Transient conservation equations, often employed by thermodynamicists, 
