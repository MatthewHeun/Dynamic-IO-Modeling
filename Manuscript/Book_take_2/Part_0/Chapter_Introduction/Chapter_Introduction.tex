...
\subsection{Natural resource limits}
...
Highly volatile oil prices are an indicator of how very little 
spare oil production capacity exists in the world today. 
%A ****\% change in demand following the 2009--2009 
%**** Do we mean just one year? ****
%recession
...
\begin{svgraybox}
{\large \textbf{Scarcity of natural resources: two perspectives}}
\\\\
**** Economic argument ****
Economic theory predicts that as demand, and thus the price, of a product increases,
more producers will enter the market 
thereby increasing supply or offering alternative products. 
**** Becky, can you clean this up? ****
Historically, the price of oil has remained below \$20 a barrel.
In the period between 2001--2008,
the price of oil increased nearly nine-fold,
...
an increase of only around 10\%.~\cite{EIA2014}
Since 2010, the price of oil has remained above \$80 per barrel,
suggesting that production cannot increase enough to bring price
back down to historical levels.
Persistently high prices in such an important commodity as oil
suggest very real limits to production

**** Physical argument ****
The balance of probability suggests that, in general,
the easiest resources will be extracted first;
as the easier resources are depleted,
attention turns to more-difficult-to-extract resources.
For instance, 
as conventional oil resources are depleted,
producers turn to resources that are further offshore,
in harsher environments,
require enhanced extraction methods
(such as steamflooding or hydraulic fracturing) or,
require completely different extraction methods,
such as oil sands.
Alternatively, the extraction of ores of finer and finer grades
requires the processing of greater amounts of unwanted materials.
This extra processing takes more energy and
the energetic cost of extracting many materials is certainly increasing.~\cite{Mudd2010}
Having to reach deeper and farther 
...
or between natural resources may alleviate the problem of natural resource scarcity,
...
\subsection{The disconnected economy}
...
%Metabolisms struggle mightily to achieve a new equilibrium
...
We contend that society is not accounting adequately %counting materials and energy 
