...
\section{ Time for a fresh approach}%BRH section
...
\begin{quote}It is difficult to say when, or how, the current economic growth ''system'' will collapse;
...
An ironic consequence of re-connecting economic analysis to the biosphere is a re-emergence of the discussion about a nation's wealth as well as its income. GDP is simply a measure of income, a flow. A nation's wealth includes its stock of 
capital, manufactured as well as natural (and human, social, and financial). Policies that focus on
...
mainstream economic theory can go easily awry. Other
...
countries such as Nigeria (see Preface). As Robert Ayres foresaw, this is not 
