...
\begin{quotation}
\emph{Where there is no reliable accounting 
...
*** BRH asks Matt and Mik whether this paragraph has a place in the introduction 
or maybe in Chapter 8 instead? *** 
...
the economy metabolizes energy that it receives from the natural resources
 into forms usable for human purposes.*** BRH says: should we add more to this discussion referring to the J Ind Eco? ***
