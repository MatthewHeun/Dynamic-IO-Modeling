...
\begin{quotation}
\emph{The world needs another industrial revolution 
...
has appeared.~\cite{Bernardini1993, Wernick1996, Cleveland1998}
...
that we can understand how best to manage the necessary
transition of our economies.
...
\caption[A comprehensive biophysical (**** Do we really mean biophysical? ****) model of the economy]{A comprehensive model 
...
\begin{table}
\caption[Examples used throughout this book]{Examples used throughout this book.}
\begin{center}
