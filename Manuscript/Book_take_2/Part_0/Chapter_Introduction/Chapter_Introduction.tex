...
In the case of a natural resource, if that does not happen
...
http://www.econlib.org/library/YPDBooks/Jevons/jvnCQ0.html -- and, Jevons' died in
1882 *** assessment of 
...
\begin{enumerate}
	...
	\item{can change in discrete, non-linear fashion with the potential for structural transformation, and}
