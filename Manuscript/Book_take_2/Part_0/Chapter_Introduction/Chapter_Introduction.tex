...
Figure~\ref{fig:gdppc} shows 5-year moving average 
...
% Despite the fact that growth rates for China and India are expected
% to slow somewhat in the coming decades,
% the significant catching up of their output to that
% of the entire OECD highlights the wall that the mature,
% OECD economies are hitting.
...
the upward trend in quality of living. 
...
The above analyses represent mainstream explanations for the growth slowdown,
...
how it would end in a financial collapse like the ''Great Recession:''
...
Today's mainstream measure of economic health, GDP, measures only \emph{income}, 
a flow.  
A nation's \emph{wealth} is made up of its physical stock,  including its stock of  
manufactured and natural capital. These, as well as human, social, and 
financial capital, provide the flow of services an economy
uses to produce income. The greater the ability
of a nation's stock to proivde a flow of necessary services,
the greater the inocme an economy can produce.
However, manufactured and natural capital
depreciate, or are depleted, as they are used
to produce the current generation's income.
To maintain a constant or increasing
standard of living, today's generation must
forego some of its consumption and 
invest in the maintenance, repair, and
replacement of capital. From Robinson Crusoe
to the US, every economy must answer this question: how much
of today's income should be consumed today and how much should be saved
for tomorrow. 

Because GDP adds consumption and investment in manufactured capital
together to calculate income,
the fundamental trade-off between today and tomorrow is masked. 
Indeed, this fundamental trade-off seems no longer relevant to the modern era
because  each generation has been able to produce more output
than the previous generations. However, the ability to do so 
has reached a limit in both the stores of non-renewable
sources of energy and the  capacity of the biosphere
to assimilate all of society's pollution and physical waste. 
...
water purchased by Toledo households.  Thus, mainstream policies focused on
...
Factor substitutability is limited, however, as the results from the oil embargo of the 70s 
painfully revealed. Thus, both natural and manufactured capital are important, 
and both should be accounted and reported for a society's 
...
Some natural capital is accounted for. Natural capital that is both owned (by firms or the government) and used in production
...
countries currently are putting their future
generations at risk in order to provide income
for the current generation. Many countries 
would be surprised to learn the true state
...
had declining  wealth at the same time their income 
was growing. Thus, they diminished the productive capacity of future generations
...
What does it look like to take account of biophysical factors in economic analysis? 
...
\subsection{Stall is related to non-renewable stocks}%[MKH] 
...
%\section{Prescriptions may be worse than the disease}%[MKH] 
