...
end of the era of economic growth.
A striking example comes from 
inter-disciplinarian Robert Ayers who, in 1997, presciently described 
how it might end:
...
\begin{quote}
	...
	unless we change course sharply.\cite{ayres1997}
\end{quote}
...
re-emergence of the discussion about a nation's wealth as well as its income. 
Today's mainstream measure of economic health, GDP, measures only \emph{income}, 
a flow. 
A nation's \emph{wealth} includes its stock of capital, 
manufactured as well as natural (as well as human, social, and financial). 
Mainstream policies focused on
increasing economic growth (as measured by GDP), 
attempt to increase financial flows without
considering the the effect on natural stocks. 
% This is why policy prescriptions based on
% mainstream economic theory can have long-term unintended consequences.

**** Becky, I edited to this point and ran out of time. ****

Economists place their faith in the ability of manufactured capital 
to continually increase production rates, 
but ignore any constraints provided by stocks of natural capital in the biosphere. 
While energy is counted as an input into the manufacturing process,
...
Because both natural and manufactured capital are important, 
