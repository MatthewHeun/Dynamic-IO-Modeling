...
This book presents a new model that explicitly accounts for the interactions
 between the economy and the biosphere; that accounts for capital that has accumulated in the economy; 
and ***BRH to continue, unless someone else gets on this before I get back at 3:30pm Wed.***
...
**** New paragraph ****
In this section and following, we answer the above questions
and, in the process, sketch an outline for our new approach 
to thinking about and accounting for materials, energy, and the economy.
Thereafter, Chapters~\ref{chap:materials}--\ref{chap:intensity} 
fill in the details for the outline.
...
we identified an apt metaphor and model for the economy 
...
applied at the economic sector level through an Input-Output framework.
...
\begin{itemize}
	\item{real economies convert raw materials extracted from the biosphere
		 	into engineered objects that accumulate as 
			the infrastructure of the economy,}
	\item{accumulated materials and infrastructure require maintenance,
			thereby placing additional material and energy demands on the biosphere, and}
	...
	\item{rapidly growing economies have large accumulation rates, 
			and accounting only for consumptive material and energy flows
			underestimates the energy demands of those economies.}
\end{itemize}

To include accumulation of materials and embodied energy, 
we had to re-think the I-O framework 
and re-derive the I-O accounting equations
to allow accumulation, as shown in the following chapters. 
