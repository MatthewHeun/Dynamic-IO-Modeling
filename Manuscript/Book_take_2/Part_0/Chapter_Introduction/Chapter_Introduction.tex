...
The third section (Section~\ref{sec:IO_waste}
looks at further extension of the input-output methodology
other material extractions from the biosphere and also
to track discharges from the economy back into the biosphere.
In the fourth section (Section~\ref{sec:IO_dynamic}
