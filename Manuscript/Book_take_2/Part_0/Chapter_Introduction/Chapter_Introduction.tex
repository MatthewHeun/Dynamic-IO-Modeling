...
That producers continue to reach deeper and farther 
and that energetic costs of production continue to rise
provide physical evidence that the world is reaching natural resource extraction limits.
...
\section{Material and energy transformations}
%+++++++++
...
\subsection{The isloated economy}
%+++++++++
...
we need to make sense of real-world events, 
we need to learn where and how economies can go wrong, and
...
And, our counting needs to be informed by metaphors and models that are
...
Metabolisms enable non-linear structural transformations~(6)
