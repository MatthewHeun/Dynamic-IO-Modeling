...
**** The next two paragraphs are duplicated from the 
Materials chapter, Section 2.5 (Materials in the US Auto Industry).
We duplicated them here for now so that the editors can 
see the justification for the auto industry example. ****
