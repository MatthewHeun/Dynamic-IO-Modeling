...
The traditional economic model is presented as an \emph{open} system. That is, the material resources, energy
...
Because these physical elements of the biosphere are not present in economic models,
 the physical constraint they place on the allocation of resources, distribution of outputs, and 
scale of an economy have become outside the scope of traditional economic discussion.
...
is emerging. Environmental Economics, as a sub-discipline, expands the traditional model include flows to and from the Biosphere. 
...
Successful management of  local pollution, such as $SO^2$, through environmental legislation
...
represented as not only a \emph{closed} system, but the underlying linear assumptions
are relaxed. All of the inputs and outputs are accounted in the model, but it is not 
assumed that all of the relationships are linear, let alone understood. 

The guiding metaphor for this kind of economic model is an \emph{organism}. Like an organism,
