...
\begin{itemize}
	\item{Nicholas Georgescu-Roegen, Herman Daly, and Kenneth Boulding 
		for being so ahead of the curve,}
	
	\item{Cutler Cleveland, Robert Costanza, and Charles Hall 
		for showing the way on energy-economy interactions,}
	
	\item{Clark W. Bullard III, Robert Costanza, Robert Herendeen, and Stephen Casler 
		for leading the way	with energy input-output analysis,}
		
	\item{David Wasshausen at the BEA 
		for clear explanations and wise guidance in using the industry and national accounts, and}
