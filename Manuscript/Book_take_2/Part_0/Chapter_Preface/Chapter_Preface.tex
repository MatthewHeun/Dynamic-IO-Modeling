...
***BRH to check all of this : Although there is nothing in the Central Framework that prevents 
...
however, inclusive wealth is growing at a slower rate than income
in most countries.
...
but the stocks of capital that are used to produce current goods and services 
as well as the state of the capital that is bequested to the future. 
...
the international standard of System of National Accounts framework for measuring economic activity.
...
and has been influenced the development 
...
includes Environmental Accounts.***..BRH to add to citation on Trello after class***
...
to commit its IEESA resources 
**** Is this right? \emph{All} resources? MKH BRH -- yes -- the 
IEESA budget was \$400,000 and the legislation says \$400,000
is to be spent on this panel...****
to a panel convened by the National Academy of Sciences (NAS)
...
\begin{quote}
	...
	**** Do a proper citation here. MKH ****BRH TODO
\end{quote}
