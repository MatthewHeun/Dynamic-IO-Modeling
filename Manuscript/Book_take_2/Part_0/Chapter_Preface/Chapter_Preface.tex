...
report, \emph{Our Common Future}, they call for all nations to
include  a full (economic) accounting
of its use and development of natural resources as part of
...
%***note: the acronym is correct. The original name included a "integrated'' with a 
% lower-case i), but that has been dropped along the way. I just took it out here, too. --- *** BRH
...
a system such as the IEESA is implemented.\cite[p.~30]{Nordhaus1999a}

Despite the NAS panel's ringing endorsement of the BEA's work,
Congress continued to expressly forbid the BEA to work on the IEESA through 2002. 
Every appropriations bill until then contained the clause:
...
Today, Congress no longer expressly prohibits work on the IEESA,
...
about the the unseen animal.
Today, scientists and economists observe two different parts 
...
But, what would we do with natural and manufactured capital data if they were 
...
We think that the benefits of environmental accounting
will be worth the political efforts that will be needed
