...
\begin{enumerate}
	\item{What might be the optimal scale of the economy in terms of GDP and its impacts natural capital?}
...
to develop a set of satellite accounts, the System for Environmental and Economic Accounting~(SEEA),
which accompanies the UN System of National Accounts framework.~\cite{bartelmus_integrated_1991}?
The UN published the first Handbook for the SEEA in 1993.\cite{UNSEEA1993} 
...
in the European Union member states, Canada, and Australia as well.\cite{UNSEEA:aa,PhilippinesSEEAWeb} 
...
accompanied the next appropriations bill explicitly forbad the BEA from spending  
