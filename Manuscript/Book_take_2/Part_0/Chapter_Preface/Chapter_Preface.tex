...
Economists focus attention on manufactured capital as the primary factor of production (in addition to labor), 
and ignore the role of natural capital. However, as the oil embargo in the 1970's 
painfully illustrated, the economy is highly depedent on both types of capital.
...
goods and services, as well as produce more capital for future production.
...
Some tracking of natural capital stocks takes place at the national level. The UN produces an international 
standard Systems of National Accounts (SNAs) to gather, evaluate, and disseminate data on economic activity 
at the national level 
for all participating countries. Natural capital that is both owned (by firms or the government) and is used in production,
is accounted for in the SNA. However, not all countries base their national accounts on the SNA (the United States, China, 
and France do not, for example) and not all natural capital is ``owned.'' Clean air and water are
not accounted for in the SNAs, for example. 
Although there is nothing in the framework that prevents 
...
to develop a set of satellite accounts to accompany the UN System of National Accounts framework.
...
of accounts to track natural capital stocks and flows
in the European Union member states, Canada, and Australia as well.\cite{UNSEEAWeb,PhilippinesSEEAWeb} 
The Netherlands, in particular, has developed a National Accounting Matrix that 
...
of the stocks of subsoil mineral assets in the nation's portfolio. The IEESA data
and the detailed plans for additional phases of development were comprehensive and methodologically rigorous. 
...
In fact, Congress ordered 
a panel convened by the National Academy of Sciences (NAS)
 to evaluate the objectivity and methodology of the IEESA.
The review panel was to submit a report to congress before the BEA 
...
Despite the review panel's ringing endorsement of the BEA's work, submitted in 1999,
Congress continued to expressly forbid the BEA's work.
Appropriations bills from through FY 2002 contained the sentence:
...
The appropriations bills no longer expressly prohibit work on the IEESA,
