...
the forecast that they will no longer be able
to maintain robust rates of economic growth. 
This is problem, because robust economic growth is understood to be a prerequesite
...
The introduction
presented evidence for a crucial, but widely ignored by the mainstream, 
...
particularly energy.
The traditional model does not and can not perceive the slowdown
in biophysical terms, and, 
thus, its policy prescriptions can exacerbate economic slowdown in the long-term.

**** Insert from last paragraph here? ****

Although the biophysical paradigm is emerging outside of
mainstream circles, 
