...
The economic problem is framed as a stalled mechanical engine, 
...
particularly stores of low-entropy materials to produce energy.
The mainstream model does not and can not perceive the slowdown
in biophysical terms, 
thus, its policy prescriptions can exacerbate economic slowdown in the long-term.
In particular, the introduction provided evidence for the startling notion that the mainstream emphasis on
investment in manufactured capital as the key to economic growth could backfire.
Because the investment in particular forms of manufactured capital today locks in a stream of future
...
How could it be that the mainstream model could be as offtrack as to lead to even
more    The mainstream model is a mechanical, input-output model that ignores
feedback effects from the environment. A new,  biophysical, economic paradigm is emerging outside of
mainstream circles, 
