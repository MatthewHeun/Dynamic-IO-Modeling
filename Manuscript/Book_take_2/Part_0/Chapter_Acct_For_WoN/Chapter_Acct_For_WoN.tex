...
because national accounting **** reword this **** continues to operate
under the assumptions of the machine metaphor and engine model
(Section~\ref{sec:machine_metaphor}).
The metabolism metaphor is not utilized in national accounting.%
...
**** I mean in a physical (not value) sense. ****
**** Consider using ``capital stock'' instead of ``stocks''. ****
...
we extend the metabolism metaphor.
...
**** Closing sentence here. Bring home the constraints issue. ****
Regardless of the origin of material constraints 
(sanctions or economicaly-generated limits on material extraction from the biosphere), 
the effect on the economy will be the same. 
There will be ever-increasing incentive to re-use and recycle.
