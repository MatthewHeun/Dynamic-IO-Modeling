...
In a sense, economic activity is like breathing (respiration): 
O$_2$ is consumed as CO$_2$ is produced.
In larger sense, the economy can also be seen as a digestive system 
**** flesh this out. ****
...
\begin{figure}[!ht]
\centering\
\includegraphics[width=\linewidth]{Part_0/Chapter_Acct_For_WoN/images/population.jpg}
...
**** Re-write in ``should'' rather than ``would'' phrasing.
...
In short, economic activity (respiration and digestion) 
is utterly and completely dependent upon 
the biosphere. **** think about this ****
...
**** Society needs to respond. Part of the response should be blank.
