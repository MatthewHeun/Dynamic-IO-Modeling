...
the observation that economic growth has slowed
**** MCD - stagnated? **** 
in mature economies of the world 
%**** Be careful of the machine metaphor here. ****
with the forecast that growth will remain slow for the foreseeable future. 
...
who blame stagnation in the factors for economic growth 
(capital, labor, and technology) for the bleak situation. 
The solution to this economic problem stipulate 
...
As these resources are depleted,
they become more costly to produce and
economic growth suffers.
Standard economic theory, however, 
does not perceive the slowdown in biophysical terms.
In particular, we provided evidence in the introduction
...
All models are really metaphors;
a means of framing the world in an over-simplified manner.
Looking back at the introduction,
you may note that we use much metaphorical language when discussing the economy.
We speak of 
``driving'' economic growth
and of ``fueling'' the ``economic engine''
or conversely, the economy ``stalling''.
Clearly the dominant economic paradigm
is a mechanistic one.
However, 
a biophysical economic paradigm exists outside of
mainstream circles, 
and its explanatory power is becoming harder to ignore.
Below, we explore how the machine metaphor came to be
and why it is time for a new metaphor.
...
**** Becky: find a citation for this. 
Maybe Ayres, 1996? ****
The global economy
