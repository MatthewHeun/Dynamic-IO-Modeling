...
Since the SEEA framework is defined at the economy-wide (E-W) scale,
there are important questions that cannot be answered.
One such question is,
``What are the material and energetic requirements to scale up the renewable energy industry?''
This is a highly important question for the future sustainable development,
not just of nations,
but the globe as a whole.
Such an analysis would require measuring inter-sectoral (i.e., intra-economy)
flows of materials and energy.
We believe this is a necessary extension of the UN SEEA for the age of resource depletion.
