...
Metabolism applies at many levels (cellular, organism, species?),
but the economic metaphor with society has been applied mainly 
...
The analogy between catabolism and the energy sector of the economy is striking.
...
Again, the analogy between cellular metabolism and the economy is obvious.
Whereas cellular autophagy repurposes proteins and cell organelles
for re-use in an organism,
...
Perhaps the most-famous example can be found in Cuba.
...
such that there are an estimated 60,000, pre-1960 cars~\cite{Schweid:2004aa} 
(so-called ``yank tanks'') on the streets of the island.%
