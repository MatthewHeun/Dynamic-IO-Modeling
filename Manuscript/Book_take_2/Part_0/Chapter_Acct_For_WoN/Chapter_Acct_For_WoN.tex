...
The initial national accounts (published in 1947) 
...
% continues to revise and refine the US System of National Accounts
% but the focus remains the same.

% The impetus for designing a
% system for measuring economic activity
% the extreme unemployment during the Depression.
% Economist Simon Kuznets led the development,
% and the first official national accounting tables
% were published in the US in 1947.
%
% The initial national accounts were focused primarily on financial quantifications
% of flows of capital and labor
% through the economy.%
% 	\footnote{
% 	Natural resources, including energy, were, and still are,
...
% 	(barrels, tonnes, and gigajoules).
% 	}
% And, they still are. The Bureau of Economic Analysis (BEA)
% continues to revise and refine the system of national accounts
% used in the US, but the focus is on the flows of goods and
% services among sectors of the economy.
...
for the environment. The first System of National Accounts (SNA) was published by the UN
soon after the US published its first set of national accounts.
 Since then, the UN has expanded the scope of the SNA to 
include interactions with the biosphere. The UN System of
...
Is it based on the metabolism metaphor?

Is it as thorough as we think is needed?
...
Internationally, there have been some encouraging moves.
In recent years, the UN has expanded the scope 
of the System of National Accounts (SNA) 
to include interactions between the economy and the biosphere
with its System of Environmental-Economic Accounting (SEEA).\cite[p. 1]{UNSEEA2014}
These accounts report physical as well as financial flows, 
and are designed to dovetail with the SNA.
However, the SEEA has not been widely implemented. \dots 
