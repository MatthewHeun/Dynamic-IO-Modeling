...
There have been three eras in recent human experience
of the relationship between the biosphere and the economy.
We'll call them 
the era of abundance, 
the era of energy constraints, and 
the era of resource depletion.
Roughly speaking, the era of abundance spans 1850--1973 (and, arguably, 1980--2003),
the era of energy constraints covers 1973--1980, and
the era of resource depletion begins in 2003.
Each era can be characterized by
...
Each revision of understanding is reflected by a change in the dominant metaphor
that explains the economy.
We also observe changes is national accounting%
	\footnote{
	In this section, 
...
and revisions to the production function from each era to the next.

Today, we stand at the dawn of the era of resource depletion, 
and it is a natural time to review past eras
and anticipate changes ahead.
How should national accounting adapt to the era of resource depletion?
How should we measure and model economic growth?
And, what new metaphors for and models of the economy will guide the coming changes?
...
The era of abundance (1850--1973%
	\footnote{
	The era of abundance was briefly disrupted by World Wars I and II.
	})
was characterized by plentiful natural resources
relative to economic demand.
Society had not moved too far along the path predicted 
by the Best First principle (see section~\ref{sec:stall_non-renewable_stocks}),
and materials and energy were easy to obtain from the biosphere.
Broadly speaking, ecosystem services provided by the biosphere were sufficient 
...
In this era, the industrialization of many economies was possible 
precisely because of the abundance of natural resources.
The binding economic constraints were the availability of 
manufactured capital and labor, and 
increasing the rate of growth of either one generated, 
to a greater or lesser degree, 
economic growth.

In this era, the dominant metaphor for the economy 
was the clockwork mechanism from classical physics.
The traditional model of the economy that follows 
from the clockwork metaphor
is shown in Figure~\ref{fig:perp_motion_1}.
Goods and services flow from the production sector
to the household sector~(consumption)
in exchange for payments.
The factors of production (manufactured capital and labor)
...
that helps us make sense of the world around us, and
the traditional model of the economy~(Figure~\ref{fig:perp_motion_1}) 
is unashamedly mechanistic.
In fact, general equilibrium models of the economy
...
Economic output ($y$) was deemed to be a function of 
factors fo production (manufactured capital,~$k$, and labor,~$l$),
...
\end{equation}	 
%
where $\alpha$ is the factor share between manufactured capital~($k$) and labor~($l$).

In the era of abundance, the clockwork metaphor was, in some sense, appropriate: 
capital and labor were the key drivers of economic growth.
And, national accounting reflected these realities. 
When systems of national accounts were created, 
their focus was squarely on financial quantifications 
of capital and labor flows through the economy.
...
scale of an economy 
are outside the scope of economic discussion.\cite{Daly1995}
...
models.%
	\footnote{This fallacious process is known as
...
Economists ignored the role that energy plays in the economy.
...
The era of energy constraints was characterized by low supply of energy,
particularly oil, 
relative to demand.
...
%%%%%%%%%% Era of resource depletion %%%%%%%%%%
\subsection{Era of resource depletion}
\label{sec:era_of_resource_depletion}
%%%%%%%%%%

The era of resource depletion is dominated by the effects 
of natural resource depletion,
specifically constrained natural resource extraction rates (relative to demand)
caused by declining $EROI_{soc}$ for oil, 
and insufficient assimilative capacity of the biosphere
