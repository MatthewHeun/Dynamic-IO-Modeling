...
**** Start writing here! ****
This book outlines a rigorous theoretical framework that could be adopted in systems of national accounts (SNA) to properly account for accumulation and flows of capital within the economy and important flows between the biosphere and the economy (2a and 2b). In so doing, we also make progress in accounting important stocks of natural resources (2c). The framework presented herein provides guidance for which data are to be collected, aggregated, and disseminated.

Borrow from last section of previous introduction.
