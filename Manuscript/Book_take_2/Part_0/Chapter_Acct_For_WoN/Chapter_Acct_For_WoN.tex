...
**** MKH reword: or disruption of supply due to wars ****.
...
Indeed, Figure~\ref{fig:Cleveland1984} can be seen as a response
...
**** Eliminate elipses **** The International Energy Agency (IEA) 
...
but rather 
by politically-motivated withholding of supply **** or disruption due to wars ****.
...
but the level of the capital was not thought to constrain
the extraction rate.
In that era, neither the machine metaphor nor engine model assumed that 
...
is that natural capital constrains economic growth.
...
In the next section, we present a new metaphor, 
