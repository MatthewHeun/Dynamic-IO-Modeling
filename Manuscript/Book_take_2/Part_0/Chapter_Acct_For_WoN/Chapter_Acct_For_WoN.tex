...
Bigger (more capital).
Also, throughput more material and energy.
Stuff like packaging that never gets emplaced.
Scale in terms of flows that aren't capital stock.
...
**** 
2.4.5 Benefits of the metabolism metaphor.

2.5 New national accounting.

Check the outline in Google Docs for any pieces of 
BRH section that could go into new national accounting.
****
...
Without materials and energy from the biosphere,
the economy collapses and society fades away.
...
**** 
Consider the following sentence to be the intro setence for the new section.
****
...
This is already emerging internationally at the economy-wide scale.

There are things to be seen in the inter-sectoral level, too.
...
it is the topic of the next subsection,
and its answer provides the structure for the heart of the book.
...
**** Bold these questions to see how they look. ****
...
\begin{enumerate}
    ...
    \item{How is scarce fossil fuel dependency embedded 
...
**** Incorporate bulleted (numbered?) list. ****
