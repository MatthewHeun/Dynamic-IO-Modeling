...
\cite{Liu2012, Giampietro2000, Giampietro2013, F-K1999, F-K2003},
**** Mik--add Gowdy and Heijman references? ****
...
use the metabolism metaphor as a simple framing device for analyses of
...
stocks of raw materials in the biosphere.%
	...
	\end{equation*}
	thereby focusing on accumulation of stocks.
	}
...
To cast the metabolic metaphor as an analogy,
it could be said that economic activity is respiration.
...
It's not hard to imagine that dynamics similar to Cuba's will emerge
...
\section{[MKH] Benefits of the metabolism metaphor}
...
the metabolism metaphor teaches us that the economy is a \emph{physical} entity
that is unequivocally sustained by the biosphere
...
metabolims fail and organisms die. 
Without materials and energy from the biosphere,
the economy fails and society fades away.
In short, economic respiration is utterly and completely dependent upon 
the biosphere.
...
The metabolism metaphor (autophagy) indicates that stocks 
of capital within society are reservoirs of 
material and (embodied) energy that can and should be 
broken town and re-used
rather than discarded when out of service.

Through an understanding the deep interconnectedness and complexity
of organisms and species in the biosphere, 
we will come to realize the Byzantine connections
among actors and sectors within the economy.
Furthermore, an appreciation of the complex nature of economies will lead us 
...
a fuller understanding of the metabolic metaphor would lead us to acknowledge
...
and stocks 
(e.g., capital, monetary savings, non-renewable energy supplies).
Furthermore, the physical basis of the real economy would lead us 
to account for \emph{both} stocks and flows 
in physical units (kg and kJ) as well as financial units (currency).

Deeper understanding of the metabolic metaphor would, presumably, 
lead systems of national accounts to become
focused as much on stocks as on flows.
Systems of national accounts would expand beyond financial accounting
to become a compendia of both the physical as well as the financial assets
of an economy.
National accounting would provide a comprehensive picture 
of the \emph{health} and \emph{wealth} of economies
by counting flows and stocks, respectively, in both physical and monetary units.

In summary, the metabolism metaphor helps us to see more clearly
and understand more deeply
how the real economy operates.
If taken to heart by the economic establishment,
the metabolism metaphor 
should lead to significant changes in national accounting.
...
**** 
Becky-if you compare this section in our detailed outline 
with the previous section I wrote above (Section~\ref{sec:metabolism_helps}),
I think you'll find quite a bit of overlap. 
This may have been Charlie's concern.
One thing to consider is to focus this section on what would change
\emph{in national accounting}.
Perhaps give specifics about which flows should be accounted that are not accounted now.
Anyway, make sure that you vet each thing you want to write here against what has been
written in Section~\ref{sec:metabolism_helps}.  
I wouldn't be opposed to moving some stuff from the section above to this section, too.
****


%%%%%%%%%% Rigorous framework %%%%%%%%%%
\subsection{[MKH] Rigorous theoretical framework}
\label{sec:rigorous_framework}
%%%%%%%%%%

If one agrees that society must respond 
to the material and energy scarcity that
we now face (Chapter~\ref{chap:intro})
and that part of the response
should involve more-comprehensive national accounting 
(Section~\ref{sec:what_would_change}) 
guided by a deeper understanding of the real economy 
gained by the metabolism metaphor (Section~\ref{sec:economy_metabolism}),
...
of national accounting in the age of resource scarcity.

This book is an attempt to provide just that: 
a theoretical framework
for comprehensive national accounting
that could be adopted in systems of national accounts (SNA) 
in an age of resource scarcity.

The first question above (``what should we be counting and in what units?'') 
is critically important
and the topic of the next subsection.
Thereafter, the answer to ``what to count?'' provides the structure 
for the heart of this book.
...
We believe the key to understanding resources and energy in an age of scarcity 
...
\noindent{}each flows and accumulates within society's metabolism, the economy.
...
\begin{enumerate}
    ...
    \item{How scarce fossil fuel dependency embedded in the interlocking fabric of the economy?} 
...
provides the structure for both the heart of our rigorous theoretical framework
