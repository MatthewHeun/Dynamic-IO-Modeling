...
Fixed Assets &  Fixed Assets Table. Detailed Fixed Assets Table. 
	...
	Clicking on the \emph{National} tab, scroll down to \emph{Fixed Assets}, 
	click on \emph{Fixed Assets Tables}; 
	Under \emph{Additional spreadsheets and tables},
	click on \emph{Detailed Data for Fixed Assets and Consumer Durable Goods}. 
