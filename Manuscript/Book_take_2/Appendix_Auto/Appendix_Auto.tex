...
Capital             &  14,532      &   2011  Fixed Assets (non-residential detailed estimates).
	The total amount of Capital Investment by the Auto Industry (\$15,301) 
	less the purchase of capital made within the Auto Industry (\$795). 
	These figures exclude Intellectual Property, see the explanation for
...
Capital (self-use) &  795    & 2011  Fixed Assets (non-residential detailed estimates).
	The authors designated Capital flows as ``self-use'' if the fixed Assets were	
	the types of 
	capital made in the Automobile Industry: 
	Autos, Internal combustion engines, Light trucks (including utility vehicles), 
	Other trucks, buses and truck trailers. This figure is calculated by subtracting a sizeable
	figure for  intellectual
	property from the total value of Capital flows that had been designated as self-use (\$15,181) .
	Intellectual property includes R\&D owned by the Auto industry (\$14,133)  as well as some software made 		within the Auto industry (Custom software, \& Own account software.)\tablefootnote{To confirm 
...
Net Economic Output & 347,513   &   2011 Input-Output accounts. 
	...
	(\$795, calculated above) and less Self-Use of Resources 
