...
and capital stock that would otherwise have
...
An effect of recycling is to reduce the magnitude 
of the waste 
$\left(\vec{B}_{waste}\right)$
and depreciation 
...
Berry and Fels found that recycling one automobile
would result in 12,640 kWh of energy reduction.\cite[p. 15]{Berry:1973vo}
...
from the biosphere ($\vec{E}_{0}$), 
therefore recycling will put downward pressure on 
