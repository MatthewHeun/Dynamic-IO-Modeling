...
Rather, we believe that energy intensity~($\boldsymbol{\varepsilon}$) is an 
...
The term is subtracted, because waste material flows \emph{out of}
the sector. 
In a physical accounting framework, the energy embodied in waste flows  
