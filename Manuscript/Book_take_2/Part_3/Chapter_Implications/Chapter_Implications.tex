...
Economic growth could be considered a ``fully coupled'' problem:
...
($\vec{B}_{K}$, $\dot{E}$, $\dot{R}$, and $\vec{T}_{1}$)
is necessary, but not sufficient, for economic growth.
There are many pieces of unfinished business here:
whether ``growth'' should be considered a stock or a flow, 
measures of economic ``growth,'' 
and the role of capital stock, labor, currency, and energy in economic processes
are overlapping and complementary areas of inquiry.
We encourage further research in these areas.
