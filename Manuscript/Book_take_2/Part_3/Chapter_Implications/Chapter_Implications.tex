...
Growth of Gross Domestic Product (GDP) is virtually the only gauge that developed
...
In ``extract and export'' fueled economies, the opposite may occur.  GDP grows
as resources are extracted and sold, but $\vec{B}_{K}$ remains flat if that income is not 
investing back into the economy as capital. An example of this
occured in the underdevelopment of the Amazon from 1600 to 1980. Per capita incomes increased by 
a power of 10 from 1820 to 1900 during the rubber export boom. However, 
as the value of rubber exports dropped due to stiff competition from Asian rubber production, per capita incomes dropped 
precipitously back to original levels. Throughout this period, the stock of embodied energy ($\vec{B}_{K}$) remained nearly constant.~\cite{bunker1984}
