...
Costanza points out that 
``[Traditional] [i]nput-output methodology does not include capital stocks explicitly, 
...
financial resources (as represented by $X_{2 \ldots n}$) 
