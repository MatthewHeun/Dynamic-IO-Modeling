...
we can lean on the ecosystem work of Eugene Odum
...
The main point was that ecosystems cannot
...
\noindent{}again, implicitly ignoring both value and energy embodied within
flows of capital. 
These implicit assumptions are consistent with the upper-left quadrant
of Figure~\ref{fig:coords_of_analysis}. The energy intensity equation
...
(i.e., we should be on the lower row of Figure~\ref{fig:coords_of_analysis}).
...
Our recommendation is based on the belief that
...
(lower-right quadrant of Figure~\ref{fig:coords_of_analysis}) 
yields Equation~\ref{eq:intensity_lower_right}. 
...
and associated embodied energy within sectors.
