...
The BEA\index{Bureau of Economic Analysis} Industry Accounts 
...
demands as the stock of biomass\index{biomass stock}~($B$) increases.
...
the energy production per unit of biomass stock\index{biomass stock}~$\left( \frac{P}{B} \right)$
is high.
As the ecosystem approaches maturity,
this ratio decreases.
Put another way,
the biomass stock\index{biomass stock} (maintained) per unit of energy produced
...
the goal of maintaining biomass stock\index{biomass stock}.
...
Energy analysts in the mid-1970s were utilizing the BEA\index{Bureau of Economic Analysis}
I-O tables\index{input-output tables},
...
\begin{itemize}
	...
	of energy embodied\index{accumulation!of embodied energy} in capital stock,
...
through economies, namely the accumulation of capital\index{accumulation!of capital}
...
accumulation of embodied energy\index{accumulation!of embodied energy} 
...
and depreciated
capital stock~$\left(\hat{\boldsymbol{\gamma}}_{K}\vec{B}_{K}\right)$
...
of embodied energy\index{accumulation!of embodied energy} within the economy
$\left(\frac{\mathrm{d}\vec{B}_{K}}{\mathrm{d}t}\right)$
...
energy embodied\index{accumulation!of embodied energy} in capital stock
$\left(\frac{\mathrm{d}\vec{B}_{K}}{\mathrm{d}t}\right)$,
...
the accumulation rate of energy embodied\index{accumulation!of embodied energy} 
in capital stock
$\left(\frac{\mathrm{d}\vec{B}_{K}}{\mathrm{d}t}\right)$ 
...
of man-made capital\index{accumulation!of capital}~($K$) 
