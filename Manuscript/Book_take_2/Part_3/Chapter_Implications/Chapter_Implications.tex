...
\motto{There is more to the idea of value than embodied energy or survival advantage. 
But, neither can the economy subsume the entire natural system under its managerial
dominion of efficient allocation. This vision of the earth as an alchemist's
centrally planned terrarium, with nothing wild or spontaneous but
everything base transformed into gold, into its highest instrumental value
for humans, is a sure recipe for disaster.~\cite[p. 11]{Daly1996}
\hfill---\emph{Herman Daly}}


%%\motto{The economy is a wholly owned subsidiary of the environment, not the reverse.~\cite[. xiv]{Nelson1994}
%% \hfill---\emph{Senator Gaylord Nelson}}
