...
In thermodynamics,
the condition of a zero rate of accumulation of some stock $x$
...
$\dot{S}_{0}$, it is likely that 
economic growth might decrease
and possibly even become zero or negative
