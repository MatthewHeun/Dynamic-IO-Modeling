...
Historically, the I-O method has been used 
to estimate the energy intensity of economic products ($\boldsymbol{\varepsilon}$).
Thus, we will take as our starting point Equation~\ref{eq:epsilon_leontief_with_A}.
...
the various ways energy analysts have used equations
analogous to Equation~\ref{eq:epsilon_leontief_with_A}
for the purpose of estimating $\boldsymbol{\varepsilon}$.
As we investigate, we will consider
product-based vs.\ physical accounting approaches,
the importance of capital stock, and
how energy input from society to the economy should be treated.
...
We begin with the distinction between product-based 
and physical accounting approaches.
