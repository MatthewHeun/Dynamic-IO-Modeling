...
\noindent{}The term $\dot{B}_{j,waste}$ represents the energy embodied 
...
Bullard and Herendeen~\cite{Bullard1975},
...
it is important to clearly define the terms in use at the time.
...
For a physical accounting system that includes , 
...
In contrast, a product-focused accounting system assigns 
all energy embodied in wastes and captial stock to the products of the sector.




Product-focused accounting systems do include an embodied energy stock 
for each economic sector ($\vec{B}$).


We have developed a physical accounting system that accounts for capital stock 
...
energy demand as new industries and products arise 
...
namely that because capital stock and waste exist 
solely because of the products, energy embodied in capital and waste should be
assigned to products. 
However, the product-focused approach masks structural aspects of economies
that we believe are essential to fully understanding how energy flows 
through economies.
The metabolic metaphor provides guidance here.  
Unless we account for the stock of energy embodied within a organism, 
the organism doesn't exist.
