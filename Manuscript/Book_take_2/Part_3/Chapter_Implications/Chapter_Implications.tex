...
Next, we view the concept of a steady-state economy through
...
of sustainability.
Finally, we discuss a technical issue
regarding the choice of energy input vector
and find that attempts in the literature to allocate energy
...
implications for recycling, reuse, and dematerialization, 
comparisons between our framework and the notion of a steady-state economy,
and the choice of the energy input vector.
...
from continuous monitoring of several important metrics, including

* energy intensity of products of economic sectors (Ch 6)

* total accumulation of material (Ch 2) and embodied energy (Ch 4) in economic sectors

* the accumulation rate of material (Ch 2) and embodied energy (Ch 4) in economic sectors

* the flow rate of energy from the biosphere into economic sectors (Ch 3)

* the flow rate of materials from economic sectors to the biosphere (Ch 2)

* the flow rate of embodied energy from economic sectors to the biosphere (Ch 4)

It would be very helpful if these metrics were available for sectors and/or firms 
on a regular basis.  

Both initial conditions and periodic reporting of important data 
...
society would understand better the costs (in terms of both dollars AND energy) 
...
****
MCD - does this subsection flow from the IO method,
or is it more general?
I.e., should they be their own sections?
****
...
driver of demand
and may also constrain available supply,
as illustrated by this quote from Meadows,

%**** MCD - Meadows quote should be somewhere here
\begin{quote}
...
(Final Consumption, in example economies A--C) % chktex 8
...
The metabolic metaphor (Chapter~\ref{chap:acct_for_won}) provides guidance here. 
...
**** Mik asks ``Do we want to discuss the Simon-Erlich wager here?''
I feel like it is important to discuss that Simon won more by
luch than judgement. See~\cite{Kiel2010}. ****
%@article{Kiel2010,
...
is reuse and recycling of materials\footnote{How 
	our accounting framework may be extended
	to include recycling is discussed more in
	Section~\ref{sec:recycling_and_waste}
	}
from both
short-lived goods
...
**** MCD - from issues of scale ****
However, the metabolism metaphor suggests that 
...
with short lifetimes (cell phones, laptops, tablets).\footnote{In
	fact, cell phones are rarely included as capital goods
	by economists **** BECKY DOUBLE-CHECK ****
	}
...
as well as the concept of dematerialziation.
We viewed the concept of a steady-state economy through
the lens of our framework.
