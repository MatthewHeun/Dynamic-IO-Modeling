...
The first set of implications are for the process of estimating
...
embodied energy is accumulating within economic sectors
$\left( \left. \frac{\mathrm{d}\mathrm{\vec{B}}}{\mathrm{d}t} \right|_{\mathrm{other}} \right)$.
But, at present, we know of no way to obtain estimates of
$\left( \left. \frac{\mathrm{d}\mathrm{\vec{B}}}{\mathrm{d}t} \right|_{\mathrm{other}} \right)$.
...
comes from one of the ways that $\bm{\varepsilon}$
is often used: to estimate $\vec{E}_{0}$.
