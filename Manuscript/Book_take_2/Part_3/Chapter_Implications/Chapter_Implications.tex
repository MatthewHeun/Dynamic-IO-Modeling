...
has been the ability to estimate energy intensity
...
****** Need to verify the equation comparisons here. 
Why do I have a different order for \ref{eq:epsilon_leontief_with_A}
