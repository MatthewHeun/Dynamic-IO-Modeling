...
One of the historical benefits of the I-O method
has been its ability to estimate energy intensity
for economic sectors. 
The I-O literature~\cite{Bullard1975,Casler1984} 
writes Equation~\ref{eq:epsilon_leontief_with_A} 
as\footnote{In fact, Equation~6 in Casler~\cite{Casler1984},
for example, is
$
	\bm{\varepsilon} 
	= \vec{E}_{0}
...
is different because Casler (and most of the rest of the I-O literature) defines $\bm{\varepsilon}$ and $\vec{E}_{0}$ as a row vectors. 
We choose to define $\bm{\varepsilon}$ 
as a column vector (Equation~\ref{eq:eps_vec_def}),
