...
A control volume around capital stock of sector $j$
of the economy yields 
...
increase the stock of capital in the economy ($\frac{\mathrm{d}\vec{B}_{K}}{\mathrm{d}t}$)
or
overcome depreciation ($\hat{\boldsymbol{\gamma}}_{B} \vec{B}_{K}$).
