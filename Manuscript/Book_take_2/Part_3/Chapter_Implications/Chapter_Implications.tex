...
However, the product-focused framework that includes capital stock (lower-left quadrant of
...
**** Add paragraphs here about energy accounting around the 
capital stock. Switch to alpha notation. ****
...
For our framework, we chose the physical accounting approach
(which puts us in the right column of Figure~\ref{fig:coords_of_analysis}).
We chose the physical approach primarily because we believe that 
...
through the economy. 
We contend that the lower-right quadrant of Figure~\ref{fig:coords_of_analysis}
is the best place for a comprehensive accounting framework.
...
of Figure~\ref{fig:coords_of_analysis}.
So, we have moved from the nascent energy I-O literature
located in the upper-left quadrant of Figure~\ref{fig:coords_of_analysis}
the lower half of the bottom-right quadrant 
of Figure~\ref{fig:coords_of_analysis}.
...
some suggested changes to the energy I-O method.  
We recommend that Equation~\ref{eq:epsilon_leontief_with_A} **** Change to alpha equation. ****
be employed to estimate the energy intensity of economic products.
