...
constant population or constant GDP.
...
Assuming,
first,
that a steady-state economy exists when the condition 
$\sum_{j}\frac{\mathrm{d}K_{j}}{\mathrm{d}t}=0$ is met\footnote{Note
that,
...
sustainably,
then $\frac{\mathrm{d}R_{0}}{\mathrm{d}t}$ had
...
with a constant material through-put,
