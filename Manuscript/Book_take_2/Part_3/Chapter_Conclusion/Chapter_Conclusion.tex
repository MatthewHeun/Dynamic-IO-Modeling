...
We said, at the outset, that this book would be about counting:
counting materials, counting energy, and counting economic value
as they flow through economies.
...
we are using these material and energy resources today
if we are to estimate the 
magnitude of the challenge of future transitions to new materials and 
new energy sources.
...
and, in this regard, we are utilizing (thought not embracing) 
...
Because the material and energy resources upon which economies depend
are obtained from the biosphere and because wastes and depreciated
material return to the biosphere, 
we applied thermodynamic accounting equations 
to model economies that are \emph{open} to their surroundings. 
...
mainstream economists and embraced by many ecological economists.

As we developed the links between the economy and the biosphere,
we found it necessary to carefully define what is meant
by economic value.
We pragmatically accepted the subjective theory of value espoused 
by mainstream economics, despite our alliance with critics
who, we belive, rightly criticize its creation of externalities,
which are of utmost importance when considering 
materials and energy scarcity issues.
On this issue we align with the mainstream.
Although we emphatically stop short of an ``energy theory of value,''
we agree with many ecological economists
who see significant importance in evaluating and communicating 
the energy intensity of economic products.
With such information, consumers will be able to make
better choices about the products and services they consume.

Along the way, we noted that there is a paucity of data
needed to account well for materials, energy, and economic
value which flow through our economies.
...
Furthermore, we saw that there are methodological hurdles that still must be overcome.
We need a method of estimating the accumulation rate
of embodied energy in economic sectors and society 
that is \emph{independent of} estimates of energy embodied 
within produced goods if we are to accurately determine
both the rate of accumulation of embodied energy in capital stock
and the energy embodied in products.

So, in the end, this book is about more than accounting.
It is a call-to-arms of sorts for data gathering and analysis.
If we are to successfully navigate the coming transitions
to new materials and energy sources, we simply \emph{must}
understand the way we are using existing materials and energy sources now.
We can't do so without an improved regime 
of data collection and analysis about the world's economies.

And, this book is an attempt at reconciling 
mainstream and ecological economics. 
We hope that mainstream economists will see that it is 
both possible and necessary to account for materials and energy flows
...
Perhaps by finding a little common ground, we will begin
to develop the analytical tools, metrics, and knowledge
needed to make wise choices about the future.
