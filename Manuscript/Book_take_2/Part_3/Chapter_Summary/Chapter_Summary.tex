...
understand the way we are 
using existing materials and energy sources presently.
...
And, this book is an attempt to reconcile 
...
If we can find a little common ground, perhaps we will begin
