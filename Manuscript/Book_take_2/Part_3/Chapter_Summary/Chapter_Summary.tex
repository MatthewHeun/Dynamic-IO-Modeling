...
We discussed the importance of metaphor 
and the stories we tell ourselves about reality.
...
developed assuming that the economic machine is a \emph{isolated} system,
...
and its mechanistic models out of hand.\footnote{For example, 
...
and mechanistic mathematical models themselves that is the problem.
Rather, it is the application of such equations 
to an assumed isolated system
that is is worthy of criticism.
Thus, our approach herein has included rigorous application of the 
...
As such, we used control volume accounting equations 
from thermodynamics to develop our accounting framework 
...
Our mechanistic modeling approach contrasts 
