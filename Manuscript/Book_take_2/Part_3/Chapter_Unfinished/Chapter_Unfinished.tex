...
Environmental economic accounting in the US national accounts is currently non-existent. It was suspended by congress after the first
tables were published and has been on hold for twenty years. The BEA developed the
Integrated Environmental and Economic Satellite Accounts to complement the
national accounts and track the ``interactions of the economy and the environment.''~\cite{BEA1994a, p. 33} In 1994, the BEA published the first phase of tables, for subsoil resources, along with
detailed economic  accounting and environmental valuation methodology behind
the new data.~\cite{BEA1994a, BEA1994b} The first set of tables valued the stock of
 subsoil assets: oil, gas, coal, metals, and some major nonfuel minerals for the years 1947 to 1991. Each
year of data included \emph{Opening stock}, \emph{Additons}, \emph{Depletion}, \emph{Revaluation adjustment}, 
and \emph{Closing stock}. Alternative
valuation methods were were for each asset to provide a range of estimates.
****ADD CITES: (BEA1994a) \url{https://www.bea.gov/scb/pdf/national/niparel/1994/0494od.pdf} and 
(BEA1994b) \url{https://www.bea.gov/scb/pdf/national/niparel/1994/0494od2.pdf}


Unfortunately, Congress ordered the BEA to suspend all work
...
recommendation that the BEA be allowed and funded to continue its work.~\cite{Nordhaus1999a}
****ADD CITE (nordhaus1999a)  Nordhaus, William D, and Panel on Integrated Environmental and Economic Accounting National Research Council. Nature’s Numbers: Expanding the National Economic Accounts to Include the Environment. Washington, DC: National Acad. Press, 1999. **** William Nordhaus,
the chair of the panel summarized the panel's recommendations with, ``In a 
complex and wealthy country like the United States, providing information on the
structure of the economy and the environment is an essential function
of government. It deserves more support.''~\cite[p. 49]{Nordhaus1999}
****ADD CITE (Nordhaus1999) \url{https://www.bea.gov/scb/pdf/NATIONAL/NIPAREL/1999/1199od.pdf}.
Fifteen years later, Congress has yet to act on this recommendation and lift the embargo on environmental accounting.
...
As stated in Chapter~\ref{chap:value}, mainstream economics assumes 
...
We use market prices (subjctive theory of value) for pragmatic, rather than philosophical, reasons. 
The information and signals provided by markets and prices are not sufficient to guide economies situated within a ``full'' earth. 
National economic accounting limits its focus to measuring value-added, 
but ignores that to which value is being added. 
This leads to overstatement of economic value flows. 
...
This drawdown of capital is mis-measured in GDP as income.~\cite[p. 66,75]{Daly1996}

Therefore, as ``that to which value is added'' diminishes, 
economic growth begins to reach binding constraints. Identifying the optimal economic 
scale---amount of materials put through the economy---that 
is viable for the biosphere to handle is an optimization problem. However, this is an optimization 
problem that the market is unable to solve on its own. 

Our model provides a natural starting place for extending the models to better
able to guide economies situated within a ``full'' earth. 
...
%\index{Thermodynamics!Fourth Law|see{Fourth Law of Thermodynamics}}
...
This has direct implications for dematerialization
of our economies, 
...
for example, in order to transport a human by
some means of propulsion,
a car must have some minimum embodied materials.\footnote{Note
...
much of the progress by ``developed'' 
