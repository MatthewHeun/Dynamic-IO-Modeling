...
a certain amount of unfinished business is inevitable. 
...
This drawdown of capital is mis-measured in GDP as income.\cite[pp.~66~\&~75]{Daly1997}
...
The BEA\index{Bureau of Economic Analysis} developed the
...
In 1994, the BEA\index{Bureau of Economic Analysis} published the first phase of tables, for subsoil resources, 
...
Unfortunately, Congress ordered the BEA\index{Bureau of Economic Analysis} 
to suspend all work
...
BEA's\index{Bureau of Economic Analysis} methodology.
In 1999, the review panel submitted its thorough evaluation as well as its strong
recommendation that the BEA\index{Bureau of Economic Analysis}
be funded to continue its work.\cite{Nordhaus1999a}
William Nordhaus,
chair of the panel, summarized the panel's recommendations with, 
...
energy\index{accumulation!of embodied energy} in sectors of the economy.
...
An important metric in this regard is the
\emph{energy return on investment}\index{energy return on investment}~(EROI),
...
The Second Law of Thermodynamics\index{Second Law of Thermodynamics} provides, 
among other things,
...
which combines the First\index{First Law of Thermodynamics}
and Second\index{Second Law of Thermodynamics}
...
\begin{quote}
	...
	alongside a traditional First Law\index{First Law of Thermodynamics} energy analysis 
...
since we make no use of the Second Law\index{Second Law of Thermodynamics},
...
One statement of the Second Law\index{Second Law of Thermodynamics}
...
as well as 
solar thermal\index{solar thermal energy}, 
solar photovoltaic\index{photovoltaic}, 
wind\index{wind energy}, 
ocean thermal\index{ocean thermal energy}, 
hydro\index{hydro energy}, and
biomass\index{biomass energy}
renewable energy\index{renewable energy}
production sectors.
...
\begin{enumerate}
	...
	\item{the points of conversion to useful work, 
		...
		(called the Direct Energy Conversion\index{direct energy conversion}
		(DEC) method.}
\end{enumerate}
...
and that the DEC\index{direct energy conversion} method is unwarranted.
...
\begin{enumerate}
	...
	\item
		...
		the accumulation of embodied energy\index{accumulation!of embodied energy} within 
		an economic sector.
