...
%%%%%%%%%% Example A %%%%%%%%%%
\section{Example A: single-sector economy energy intensity ($\varepsilon$)} % chktex 13
%%%%%%%%%%
...
%%%%%%%%%% Example B %%%%%%%%%%
\section{Example B: two-sector economy energy intensity ($\varepsilon$)} % chktex 13
%%%%%%%%%%
...
%%%%%%%%%% Example C %%%%%%%%%%
\section{Example~C: three-sector economy energy intensity ($\varepsilon$)} % chktex 13
...
%%%%%%%%%% Example C %%%%%%%%%%
\section{Example~C: Matrix formulation} % chktex 13
\label{sec:C-matrix}
%%%%%%%%%%
...
\noindent{}where the Kronecker delta is
...
Equations~\ref{eq:X_t_matrix_def}--\ref{eq:X_hat_matrix_def}
