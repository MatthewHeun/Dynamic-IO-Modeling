...
\1 What we are not doing: creating a new ``energy theory of value''
	...
	\2 
\2 we think that is too reductive, narrow, causes a problem. 


\1 what we are doing: using subjective theory of value combined with an intrinsic
measure of economic impact on the biosphere
...
\2 currency is not an objective measure of the interaction processes that are happening between the economy and the biosphere

\2 monetary measures of the economy alone cannot foretell of the constraints on the horizon


\1 Instrinsic measures of economic impact include some theory of value of economic output
...
\2 despite these drawbacks, we using subjective theory of value because it is commonly agreed upon to be the best alternative

\2 this allows us to use currency flows as a first-approximation for value flows

\1One outcome of this approach is to highlight the paucity of information contained in current measures of the economy based solely on subjective values
