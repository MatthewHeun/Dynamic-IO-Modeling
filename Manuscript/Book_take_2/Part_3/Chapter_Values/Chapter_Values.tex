...
\1 What we are not doing: creating a new ``energy theory of value''
	...
	\2 econmists rejected energy analysis for two reasons: 
		...
		\3 economists rejected intrinsic theory of value promomted by energy analysts (Costanza, 1980) because it was too reductive and narrow.
...
\1 what we are doing: using subjective theory of value combined with a technique 
...
When considering flows of value, the economy is \emph{completely isolated}
from the biosphere.
The contrast between Figure~\ref{fig:A_value} and Figure~\ref{fig:A_energy}
is striking. 
Figure~\ref{fig:A_energy}'s picture of energy flows indicates a dependence
upon the biosphere that is not reflected in Figure~\ref{fig:A_value}'s
picture of value flows.
The isloation of the value flows from the biosphere is a consequence
of the subjective theory of value underlying modern economies.
The biosphere is akin to a third party without a voice 
...
An equation that describes the accumulation of value in Society (1) is

\begin{equation} \label{eq:A_X_acct}
	\frac{\mathrm{d}X_{1}}{\mathrm{d}t} 
	= \dot{X}_{11} 
	- \dot{X}_{1}.
\end{equation}

********** Is this right? The figure says $\dot{X}_{11} = \dot{X}_1$,
but in that case, $\frac{\mathrm{d}X_1}{\mathrm{d}t} = 0$, too, and
...
**** Note: $\dot{X}_1$ is GDP. What is $X_1$? 
$X_1$ is the value of everything
that has accumulated in society. Is there an 
$\dot{X}_{gen}$ term? 
Does it represent value added? ****
