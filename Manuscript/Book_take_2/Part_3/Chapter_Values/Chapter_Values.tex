...
\begin{figure}[h!]
\centering
\includegraphics[width=0.8\linewidth]{Part_3/Chapter_Values/images/PERKS_basic_unit_value_example.pdf}
\caption{2011 USD values of flows into and out of the Automobile Industry.}
\label{fig:PERKS_value}
\end{figure}

Here is an example of estimating the model using input-output data for the 2011 US motor vehicle industry.

\begin{figure}[h!]
\centering
\includegraphics[width=0.8\linewidth]{Part_3/Chapter_Values/images/PERKS_basic_unit_value_example.pdf}
\caption{US BEA provides the data necessary to estimate a PERKS model}
\label{fig:PERKS_value_example}
\end{figure}
