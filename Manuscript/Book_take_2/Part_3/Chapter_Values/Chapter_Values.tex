...
\noindent{}Realizing that ******* Need to do this derivation! ********* yields
...
\noindent{}and Equation~\ref{eq:C-value-economy-a} becomes
...
\noindent{}indicating that value generation ($\dot{X}_{gen,j}$) 
and destruction ($\dot{X}_{dest,j}$)
are the mechanisms by which value is accumulated or lost
