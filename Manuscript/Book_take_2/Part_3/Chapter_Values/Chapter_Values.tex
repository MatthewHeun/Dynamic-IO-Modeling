...
from $2$ to $3$. Making this change might have an implication
on Becky's diagram in the last section. Those are currency 
flows, not value flows. Would we want to change the direction
...
probably turn around the arrows to talk about value in the diagram, too.
****
