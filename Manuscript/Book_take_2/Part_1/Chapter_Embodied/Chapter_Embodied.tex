...
goods~($\dot{S}$),
will have no direct energy content 
...
Bullard and Herendeen (1975) calculated the
energetic consumption of the automobile industry as 
$13240 \times 10^{15}$~joules~$= 13.24$ ~EJ~\cite{Bullard1975},
which was around 20\% of the nation's
energy consumption in that year.
Around half of this energy was directly
consumed within the auto industry itself,
meaning the rest was upstream consumption
in material processing.
The value per vehicle was 148 GJ (10$^{9}$J).\@
The authors note that this value is 11\% higher
...
the economy based on national accounts from 1992,
