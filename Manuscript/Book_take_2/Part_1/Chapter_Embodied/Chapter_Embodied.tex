...
to find that the energy ``cost'' of automobile manufacturing 
in the U.S.\ was 37,275~kW-hr = 134~GJ~(10$^9$~J) 
per vehicle.\cite[Table~2]{Berry:1973vo}
**** MCD: is this the manufacturing cost or embodied energy?
Manufacturing cost suggests no upstream materials included. ****

**** MCD: maybe this next paragraph should be moved to a footnote. ****

The ``energy cost'' estimated by Berry and Fels is the 
...
Stodolsky et al. (1995) estimated the energy consumed in materials and 
...
MacLean and Lave (1998) estimated the the embodied energy
...
**** Mik: can we add at least ONE MORE estimate of embodied energy here? --MKH ****
...
savings are achieved by EVs.\cite{Anair:2012aa,hawkins2012comparative,zehner2013unclean}
