...
develops equations that describe the accumulation and flow of 
embodied energy through economies.
We noted that waste heat from a sector
...
One way to assess the level of manufactured capital 
...
it is necessary to estimate the energy embodied in products ($\dot{P}$).
...
To assess the embodied energy of products and economic sectors,
