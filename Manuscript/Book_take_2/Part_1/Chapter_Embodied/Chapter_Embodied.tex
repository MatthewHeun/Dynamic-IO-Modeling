...
to transport the stuff away.~\emph{\cite[p.88]{Mackay2008}}
...
develops equations that describe the flow of 
embodied energy through economies.
We found that waste heat from a sector
...
of our running example, the US auto industry.
We found that there are a few historical estimates of energy embodied within
automobiles.}
...
In this chapter, we will adapt the First Law\index{First Law of Thermodynamics} to account  
\emph{embodied} energy\index{embodied energy}
...
\emph{total} energy\index{total energy}. 
...
\begin{enumerate}
	...
	energy is accounted.% \footnote{If it seems a little contradictory
	%	to say both that ``total energy does not accumulate'' and
	%	that embodied energy simply accumulates in the economy,
	%	we totally agree.}
\end{enumerate}

Like the EI-O literature, we assume that total energy is conserved
and never wasted.\footnote{Of course, waste heat exists and is
accounted by the First Law of Thermodynamics\index{First Law of Thermodynamics}. 
However, waste heat is ignored when accounting for total energy.}
However, we depart from the EI-O literature by explicitly
accounting a stock 
for total energy accumulation\index{accumulation!of total energy} 
in economic sectors. 
...
The rate of accumulation of total energy\index{accumulation!of total energy} 
...
On the other hand, the First Law of Thermodynamics\index{First Law of Thermodynamics} 
...
In words, the rate of accumulation of embodied energy\index{accumulation!of embodied energy} 
...
accumulation\index{accumulation} is the difference between inflow and outflow rates. 
...
see again for Examples~A--C in the sections that follow. % chktex 8
...
substituting the First Law of Thermodynamics\index{First Law of Thermodynamics}
into 
...
\subsection{Substitution of First Law\index{First Law of Thermodynamics}
into the embodied energy accounting equation} % (fold)
\label{subsec:A_first_law_embodied}
%+++++++++

The second approach to the derivation of embodied energy
accounting equations is to substitute the First Law\index{First Law of Thermodynamics}
...
accumulation rate of direct energy\index{accumulation!of direct energy} 
$\left( \frac{\mathrm{d}E}{\mathrm{d}t} \right)$
is zero, because the 
$\frac{\mathrm{d}E}{\mathrm{d}t}$
term is cancelled by the substitution.

% Note that Equation~\ref{eq:A_dB0/dt} includes the
...
of embodied energy\index{accumulation!of embodied energy} in an economic sector 
...
Accounting for accumulation of total energy\index{accumulation!of total energy} 
...
of embodied energy\index{accumulation!of embodied energy}
...
Accounting for accumulation of total energy\index{accumulation!of total energy} and 
...
the rate of accumulation of embodied energy\index{accumulation!of embodied energy}
