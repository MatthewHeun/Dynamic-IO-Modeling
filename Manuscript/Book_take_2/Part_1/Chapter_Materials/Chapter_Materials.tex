...
such as housing.\footnote{For 
economists, capital goods are used only within 
productive sectors of the economy.
**** Becky, can you double check this? ****
}
...
\midrule
Product output							&	$\dot{P}_{j}$		&	auto parts and finished automobiles			\\[0.15cm]
\midrule
Resource self-consumption		&	$\dot{R}_{jj}$		&	auto parts												\\[0.15cm]
Short-lived self-consumption   &	$\dot{S}_{jj}$		&	none **** MCD---not sure about this ****\\[0.15cm]
Capital self-consumption			&	$\dot{K}_{jj}$		&	finished automobiles								\\[0.15cm]
\midrule
