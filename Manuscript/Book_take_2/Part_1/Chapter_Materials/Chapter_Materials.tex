...
to materials~(this chapter), 
energy~(Chapters~\ref{chap:direct_energy}~and~\ref{chap:embodied_energy}) and 
...
Energy flows are associated with all flows of materials, 
...
\emph{literally embodied} (i.e. contained) within the out-flowing product (gasoline).
...
currently available~(e.g., economic value, Chapter~\ref{chap:value}), 
...
activity.\cite{Sullivan1998, McCleese2002, Sullivan2010, Hawkins2012, MacLean1998, MacLean2003, Schweimer2000, Burnham2006}
