...
materials flowing into or out of a production sector: products (P), resources (R),
short-lived goods (S) and capital goods (K), as shown in Figure
\ref{fig:PERKS_materials}. 

Resource materials always enter the sector on the left and comprise those materials that
are destined to end up \emph{embodied} in the goods produced by the sector (P), except
...
Short-lived goods include those materials that are necessary for the production
...
the sector. Such flows are instead counted as capital goods. These flows also enter from
...
All products leave the sector from the right. Some of this flow is returned to the 
sector as self-consumption of either resources, short-lived or capital goods, the rest
...
our material accounting equations, such as:
