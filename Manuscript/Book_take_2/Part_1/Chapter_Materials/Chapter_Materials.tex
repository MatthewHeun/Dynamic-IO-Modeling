...
products ($P$) \nomenclature[P]{$P$}{products}, 
resources ($R$)\nomenclature[R]{$R$}{resources},
short-lived goods ($S$)\nomenclature[S]{$S$}{short-lived goods},
and capital goods ($K$)\nomenclature[K]{$K$}{capital goods}, 
...
Short-lived goods ($\dot{S}$)\nomenclature[S]{$\dot{S}$}{short-lived goods flow rate}  
...
\nomenclature[K]{$\dot{K}$}{capital goods flow rate}. 
