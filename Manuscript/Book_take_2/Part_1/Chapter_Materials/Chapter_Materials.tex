...
inherent in capitalist society.\footnote{
	The logic of the treadmill is:
 		\begin{enumerate}
 			\item 	more capital is becoming accumulated in Western economies, 
...
% 						as well as in the new ``research and development'' departments of large firms;
 			...
 			\item 	because worker inputs can more readily be cut back 
 						(as opposed to fixed costs of machine operations)
 						labor is further reduced to sustain production at higher levels.~\cite[p.296]{Gould2004}
		 \end{enumerate}
 }
% \begin{quote}
