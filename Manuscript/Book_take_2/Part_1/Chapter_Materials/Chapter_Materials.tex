...
goods\index{capital goods} ($\dot{K}_{11}$)\footnote{There is an open
...
are necessary constrained by the fact that the energy content of the food delivered 
...
We may also say that accumulation of capital in society ($K_{1}$)
is dependent only on inflows of capital into society ($\dot{K}_{11}$) and depreciation
of capital to the biosphere ($\dot{K}_{10}$) such that:
