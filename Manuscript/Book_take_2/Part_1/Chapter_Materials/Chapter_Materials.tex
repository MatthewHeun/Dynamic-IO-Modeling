...
such as housing.\footnote{For national accounting, 
...
**** Mik - do you want to use the above sentence instead? ****
}
...
we will apply our accounting procedure to direct energy (Chapter~\ref{chap:direct_energy})
