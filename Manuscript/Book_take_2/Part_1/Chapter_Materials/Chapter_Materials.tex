...
including: 
**** MCD - split list into resources, short-lived and capital flows as table both inputs and outputs. Maybe add annotation to Figure~\ref{fig:PERKS_materials_auto} ****
...
\midrule
Resources from biosphere	& $\dot{R}_{0j}$		& zero flow 											\\[0.15cm]
Short-lived from biosphere	&	$\dot{S}_{0j}$	& oxygen, nitrogen								\\
