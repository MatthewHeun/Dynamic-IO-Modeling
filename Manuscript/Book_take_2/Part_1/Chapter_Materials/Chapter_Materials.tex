...
proper. Other flows occur around us unseen. The cars outside is the street suck in nitrogen
...
dematerialization of the economic process, requires a whole host of
infrastructure including uninterrupted electricity, data servers, 
telephone networks, and a computer by which to access it.

In this chapter, we will define a mathematical accounting framework 
