...
opposite. All of these goods came originally from natural resources 
\index{natural resources}, be it paper or
...
per time unit ($\dot{a}$)\nomenclature[a]{$\dot{a}$}{flow rate of apples [apples/time]}, 
...
$\dot{s}$\nomenclature[s]{$\dot{s}$}{steel mass flow rate [kg/s]},
...
Short-lived goods ($\dot{S}$)\nomenclature[S]{$\dot{S}$}{short-lived goods mass flow rate [kg/s]}  
...
\nomenclature[K]{$\dot{K}$}{capital goods mass flow rate [kg/s]}. 
...
%%%%%%%%%% Materials: Example A %%%%%%%%%%
\section{Example~A: one sector economy} % chktex 13
...
from the biosphere\index{biosphere} (0). Waste resources ($\dot{R}_{10}$) short-lived materials/goods 
($\dot{S}_{10}$) and capital goods\index{capital goods} ($\dot{K}_{10}$) are returned to the biosphere.}
...
processes but are not embodied in the product output, 
...
short-lived goods and capital goods\index{capital goods} ($\dot{K}$) 
...
are returned to the biosphere\index{biosphere} without accumulating. Capital goods ($\dot{K}_{10}$) 
are returned to the biosphere\index{biosphere} upon depreciation.
...
nor short-lived goods ($S$) accumulate within economic sectors, tells us that:
...
of capital \index{capital!accumulation} within society is the imbalance 
between the flow of materials pulled from the biosphere\index{biosphere}($\dot{R}_{01} + \dot{S}_{01}$) and the 
...
is that which is a waste\index{waste} flow (capital depreciation)
...
One point worthy of noting is that what we are here denoting as a flow of `capital goods'\index{capital goods}
...
\caption{The matrix of biosphere\index{biosphere}-economy flows.}
