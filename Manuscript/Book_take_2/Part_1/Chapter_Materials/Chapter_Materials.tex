...
that to make full use of the metabolism metaphor,
...
resulting in the emission of carbon dioxide and polluted water.\cite{SweeneySmith2013}
These materials inputs are used for a number of different purposes. 
In anabolic processes, materials extracted from the environment become the building blocks 
...
the directly results in the emission of carbon dioxide. 
...
are assumed to be passed on into the product.\cite{Hawkins2012}
