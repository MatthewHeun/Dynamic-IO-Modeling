...
I've drawn a spatial boundary (control volume) around my home 
...
I can reframe the questionL ``at what rate does the stock of
...
Again, the last two terms are zero. 
...
Waste resources ($\dot{R}_{10}$) and used **** consumed? --MKH **** short-lived 
