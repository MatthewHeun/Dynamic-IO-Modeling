...
be it the eggs in our fridge, the gasoline we consume on our way to work
...
that although Equation~\ref{eq:A_CV_0a} is true for total mass of materials,
...
expended  in material extraction.\cite{Mudd2010} 
...
flow from Final Consumption (1) to Production (2) 
...
Data on the rest of the flows **** What do you mean by ``rest of the flows?''
...
manner as traditional EI-O estimates energy flows
through the economy,
