...
Engineers often call this definition a ``control volume.'' 
...
To do so, I would count the apples that enter and leave my home, 
apples that are eaten (consumed),
and, if I own an apple tree, apples that I grow (produce). 
...
Rather than looking at the total amount of apples over a week-long period, 
we may consider the flow of apples per unit time ($\dot{A}$), 
...
**** Steel equation for auto industry. ****

**** Compare to apple equation. 
Discuss how steel is neither created nor destroyed within the sector. ****

**** Discuss the steel industry. 
Show how stell is actually formed from other materials.
Show that \emph{mass} is neither created nor destroyed, 
but it may change form. ****

**** Tie to the First Law below. ****

In the discussion that follows, we will make use 
of the First Law of Thermodynamics, 
which says that \emph{mass}, i.e.
materials, and \emph{energy}
can neither be created nor destroyed. 
An eaten apple is no longer an apple, 
but wasted mass and energy are still mass and energy,
even if they change form (apples to compost or 
...
terms for processes that create and destroy apples, 
...
Resource materials are not be accumulated within a sector.
...
Examples of these short-lived flows include energy resources needed to run the sector,
including the contribution from labor, 
and any water used by the sector. 
