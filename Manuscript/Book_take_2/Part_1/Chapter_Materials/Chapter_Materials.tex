...
The last term ($\dot{K}_{10}$) represents depreciation\footnote{This
...
and may be rewritten as the total stock
...
Similarly to Example~B, we can say that:
...
Again, as in Example~B, we may state that:

\begin{equation}\label{eq:B_R11_K11}
	\dot{R}_{11} = \dot{K}_{11} = 0
\end{equation}

\noindent{}since food and capital goods
are not produced within sector~(1).
