...
flow into the economy (1) from the biosphere\index{biosphere} (0).\footnote{Double 
...
because the carbon in the coal ends up physically
\emph{embodied} within the steel.
However, again,
...
**** Mik---Footnote or strike this paragraph. ****
