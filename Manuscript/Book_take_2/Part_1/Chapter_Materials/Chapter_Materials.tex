...
\caption{**** Mik: should this figure have an arrow to the right indicating
net output? --Matt ****}
...
\begin{equation}\label{eq:dS_1/dt_single_sector}
	\frac{\mathrm{d}R_1}{\mathrm{d}t} + \frac{\mathrm{d}S_1}{\mathrm{d}t}
	= \dot{R}_{21} + \dot{S}_{21} + \dot{K}_{21}
	- \dot{R}_{12} - \dot{S}_{12}
\end{equation}

\begin{equation} \label{eq:dS_2/dt_single_sector}
	\frac{\mathrm{d}R_{2}}{\mathrm{d}t} + \frac{\mathrm{d}S_{2}}{\mathrm{d}t} + \frac{\mathrm{d}K_{2}}{\mathrm{d}t} 
	= \dot{R}_{12} + \dot{S}_{12} 
	- \dot{R}_{21} - \dot{S}_{21} - \dot{K}_{21}.
\end{equation}

\begin{equation}\label{eq:biosphere_material_steady_state}
	0 = \dot{R}_{21} + \dot{S}_{21} + \dot{K}_{21}
	- \dot{R}_{12} - \dot{S}_{12}
\end{equation}
...
\begin{equation} \label{eq:CV_R_dot_3}
	\frac{\mathrm{d}R_{3}}{\mathrm{d}t} + \frac{\mathrm{d}S_{3}}{\mathrm{d}t}
	+ \frac{\mathrm{d}K_{3}}{\mathrm{d}t}
	=  \dot{R}_{13} + \dot{S}_{13} 
	+ \dot{R}_{33} + \dot{S}_{33} + \dot{K}_{33}
	- \dot{P}_{3}
	- \dot{R}_{31} - \dot{S}_{31} - \dot{K}_{31},
\end{equation}

\begin{equation} \label{eq:CV_K_dot_3}
	\frac{\mathrm{d}K_{3}}{\mathrm{d}t}
	=  \dot{K}_{33} - \dot{K}_{31},
\end{equation}
