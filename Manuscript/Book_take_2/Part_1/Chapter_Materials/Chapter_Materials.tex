...
In this chapter, we will define a mathematical framework to track the flow of
materials within an economy, building from a one-sector economy up to examples of both
...
requires precise definition of both 
...
we can reframe the question: ``at what rate does the stock of
apples change?'' 
...
within the apple can still be traced via their elemental mass and energy,
...
the remainder flows to other sectors within the economy or final consumption. 
