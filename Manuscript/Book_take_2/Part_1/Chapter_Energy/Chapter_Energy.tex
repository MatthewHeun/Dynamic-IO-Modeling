...
Or, \emph{energy is the currency of thermodynamics}.
...
($EROI$)\index{EROI} represents the energy production \emph{per unit} of energy
invested by society in the production process.\footnote{Although
the definition of EROI, as outlined here, 
is easy to articulate,
the EROI calculation involves a multitude of system boundary
considerations.
These issues are well covered by both Murphy et al.~\cite{Murphy2011}
and Brandt \& Dale~\cite{Brandt2011} who outline varying
...
The EROI of the energy sector (2) is given by
