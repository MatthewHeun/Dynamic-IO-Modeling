...
**** MCD---There are process values in~\cite[p.5]{Sullivan2010} ****

\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\linewidth]{Part_1/Chapter_Energy/images/PERKS_basic_unit_energy_auto_ind.pdf}
\caption[Direct energy flows for the US Automobile Industry]{Direct energy flows for the US Automobile Industry using data from XXXX}
