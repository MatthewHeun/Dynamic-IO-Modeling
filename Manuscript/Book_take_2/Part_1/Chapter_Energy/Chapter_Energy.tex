...
\end{equation}
\nomenclature[i]{$i$}{economic sector index}
\nomenclature[n]{$n$}{number of sectors in the economy}
...
\noindent where $j \in [1, n]$\nomenclature[j]{$j$}{economic sector index}.
...
In 2010, the automobile industry purchased 19 billion MJ of total energy from all sources. 
...
\begin{table}
\caption[Source of Energy Inputs into US Auto Industry in 2010]{Source of Energy Inputs into US Auto Industry in 2010.}
\begin{center}
 \begin{tabular}{ l r l }
\toprule 
Source & Quantity &  Units \\
\midrule
Total  & 19 & trillion kJ \\
& & \\
Electricity & 1,765  & million kWh \\
Natural Gas & 11 & trillion cubic ft \\
...
The energy inputs consisted of of 1,765 million kWh electricity, 11 trillion cubic ft of natural gas, 
and 1 trillion Btu of other energy sources.\footnote{These data come from the 
2010 Manufacturing Energy Consumption Survey, Table 7.6 
\emph{Selected Energy Sources by Mfg. Industry \& Region (physical units)}
 produced every four years by the  US Energy Information Administration. The data can be found at this location
http://www.eia.gov/consumption/manufacturing/data/2010/\#r8.} It is interesting to note that this 
level of energy usage is less than half of the energy usage in 2006 before the 
...
underlying detailed processes in manufacturing automobiles. Sullivan et al. arrives at an estimate of the ``gate-to-gate'' energy
...
Using Sullivan's estimate in conjunction with the 19 trillion kJ of total auto industry use would suggest that there were
approximately 560,000 vehicles produced in the US in 2010. (19 million GJ divided by 34 GJ).  That is at least in the ball park of the estimated 2.7 million actual vehicles produced in 2010.\footnote{According to data from International Organization of Vehicle  at 
