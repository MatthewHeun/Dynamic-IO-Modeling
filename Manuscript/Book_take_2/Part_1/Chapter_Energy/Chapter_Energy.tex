...
including chemical potential energy\index{chemical energy}, 
nuclear potential energy\index{nuclear energy}, 
gravitational potential energy\index{gravitational energy},
thermal energy\index{thermal energy}, 
and kinetic energy\index{kinetic energy}.
...
the First Law of Thermodynamics\index{First Law of Thermodynamics} says that 
the accumulation rate 
of direct energy\index{accumulation!of direct energy} within the 
...
When there is no accumulation of direct energy\index{accumulation!of direct energy}
within the boundary
...
Thus, the accumulation rates for direct energy\index{accumulation!of direct energy} 
...
\noindent{}First Law\index{First Law of Thermodynamics}
energy accounting around the Biosphere~(0) and Society~(1) gives
...
The First Law\index{First Law of Thermodynamics} around Production (2), 
including the accumulation rate of direct energy\index{accumulation!of direct energy} 
in the sector 
...
The \emph{energy return on investment}\index{energy return on investment}
...
\noindent{}EROI\index{energy return on investment} 
represents the energy production \emph{per unit} of energy
...
energy resources from the biosphere.\footnote{Although
	the definition of EROI\index{energy return on investment}, as outlined here, 
	is easy to articulate 
	$\left( \mathrm{esstentially,} \: \frac{\mathrm{energy~out}}{\mathrm{energy~in}} \right)$,
	the EROI\index{energy return on investment} 
	calculation involves a multitude of system boundary
	considerations.
	These issues are well covered by both Murphy, et al.~\cite{Murphy2011}
	and Brandt, et al.~\cite{Brandt2011, Brandt2013} who outline varying
	EROI\index{energy return on investment} 
	...
	where GER\index{gross energy ratio} stands for \emph{gross energy ratio}
	an equivalent metric to EROI\@.
	Possible implications of declining EROI\index{energy return on investment} 
...
The First Law of Thermodynamics\index{First Law of Thermodynamics} around the 
...
The First Law\index{First Law of Thermodynamics}
around the goods and services sector (3) including, 
for now, the accumulation rate of direct energy\index{accumulation!of direct energy}
in the sector 
...
\section{Direct energy in the US auto industry}
...
(NAICS\index{North American Industry Classification System} Code 336111) 
in 2010.\cite[Table 7.6]{EIA:2014aa}}
\begin{center}
...
assisted by the First Law of Thermodynamics\index{First Law of Thermodynamics},
that describe the flow of 
