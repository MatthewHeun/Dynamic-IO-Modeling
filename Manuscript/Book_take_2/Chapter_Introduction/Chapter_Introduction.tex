...
\begin{figure}[h!]
\includegraphics[width=\linewidth]{Chapter_Introduction/images/Tradition_economy.pdf}
\caption{[BECKY TO DOUBLE-CHECK] The traditional model represents the economy as a circular flow of goods and services between two sectors. The producers manufacture goods and services by taking in labor and capital. The consumers exchange labor for wages which is used to purchase the goods and services of the producers.}
\end{figure}

\begin{figure}[h!]
\includegraphics[width=0.8\linewidth]{Chapter_Introduction/images/Basic_unit.pdf}
