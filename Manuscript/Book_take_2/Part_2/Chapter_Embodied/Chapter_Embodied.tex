...
\caption{Total energy flows ($\dot{T}$) in a single-sector Economy. **** Mik: Change left $\dot{T}_{1} = \dot{T}_{12}$ to $\dot{T}_{1} = \dot{E}_{12}$. ****}
...
**** Mik: Change $\dot{T}_{1} = \dot{T}_{13}$ to $\dot{T}_{1} = \dot{E}_{13}$ ****}
