...
\begin{figure}[h!]
	...
	\caption{Total energy flows for a single sector}{Total energy flows ($\dot{T}$) for a single sector of an economy. 
...
we sum 
Equations~\ref{eq:C_embodied_energy_accounting_0_with_depreciation} and \ref{eq:C_embodied_energy_accounting_123_with_depreciation} 
