...
\begin{equation} \label{eq:C_embodied_energy_accounting_12_with_depreciation}
	\frac{\mathrm{d}B_{j}}{\mathrm{d}t} 
	= \sum\limits_{i=1}^n\dot{B}_{ij} 
	- \dot{B}_{j}
	- \gamma_{i} B_{i}
...
**** Ended here. Need to do the verification with the sum equation. ****

To verify the above derivation, 
we sum 
Equations~\ref{eq:C-embodied_acct_0} and \ref{eq:C-embodied_acct_123},
