...
\emph{embodied} energy in the material flows of 
...
can be an indicator of the level of ``development'' of the economy.
...
equations by defining the concept of \emph{total} energy. 
...
and we see that the waste direct energy term 
...
**** Fix the following equations ****

\begin{equation} \label{eq:B_embodied_energy_accounting_1}
	\frac{\mathrm{d}B_1}{\mathrm{d}t} 
	= \dot{Q}_{31} 
	+ \dot{B}_{13} 
	+ \dot{B}_{33} 
	- \dot{B}_{31},
