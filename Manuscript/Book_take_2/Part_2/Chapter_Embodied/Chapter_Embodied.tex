...
Equation~\ref{eq:embodied_energy_accounting_1}.\footnote{Equation~\ref{eq:embodied_energy_accounting_1}
...
Equation~\ref{eq:embodied_energy_accounting_1}.
...
********** Matt finished changing indexing here ************
...
Equations~\ref{eq:B_embodied_energy_accounting_1}--\ref{eq:B_embodied_energy_accounting_3}
with depreciation terms to obtain

\begin{equation} \label{eq:B_embodied_energy_accounting_1_with_depreciation}
	\frac{\mathrm{d}B_{1}}{\mathrm{d}t} 
	= \gamma_2 \dot{B}_{2}  
	+ \gamma_3 \dot{B}_{3} 
	- \dot{Q}_{21} 
...
\begin{equation} \label{eq:B_embodied_energy_accounting_2_with_depreciation}
	\frac{\mathrm{d}B_{2}}{\mathrm{d}t} 
	= \dot{B}_{22} 
	+ \dot{B}_{32} 
	- \gamma_2 \dot{B}_{2} 
...
\begin{equation} \label{eq:B_embodied_energy_accounting_3_with_depreciation}
	\frac{\mathrm{d}B_3}{\mathrm{d}t} 
	= \dot{B}_{23} 
	+ \dot{B}_{33} 
	- \gamma_3 \dot{B}_{3}
