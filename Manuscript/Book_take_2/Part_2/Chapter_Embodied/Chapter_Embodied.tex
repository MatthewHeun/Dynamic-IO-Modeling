...
By substituting Equations~\eqref{eq:T_dot_def} and
\eqref{eq:T_accum_def} into 
Equation~\eqref{eq:total_energy_accounting},
we obtain
...
To discover this relationship, we substitute the 
First Law of Thermodynamics (Equation~\ref{eq:First_Law_with_accumulation})
into Equation~\ref{eq:total_energy_accounting_details} to 
obtain
...
The waste heat term ($\dot{Q}$) in Equation~\ref{eq:embodied_energy_accounting}
is an outflow of energy from the sector. The embodied energy 
term ($\dot{B}$) represents embodied energy on either inflows
...
Rearranging Equation~\ref{eq:embodied_energy_accounting_2} gives
...
Equation~\ref{eq:embodied_energy_accounting_3} shows that waste heat 
\emph{out} of an economic sector ($\dot{Q}$) 
is \emph{additive to} energy embodied
in the products of the sector.

**** Substitute the First Law into the Total Energy 
equation to obtain an embodied energy equation. ****.
