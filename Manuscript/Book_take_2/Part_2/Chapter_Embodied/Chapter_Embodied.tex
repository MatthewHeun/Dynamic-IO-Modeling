...
yields a version of the equation that may be more easily
understood.
...
embodied energy accounting equations. 
Equation~\ref{eq:embodied_energy_accounting_3} shows that waste 
energy flows \emph{out} of an economic sector ($\dot{Q}_{out}$) 
are \emph{additive to} energy embodied
