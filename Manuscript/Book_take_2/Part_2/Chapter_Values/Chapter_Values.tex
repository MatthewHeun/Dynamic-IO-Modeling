...
A person’s wants are malleable and are, in turn, formed within a 
``constellation of shared goals to which a society aspires.''~\cite{costanza2004}
...
we use the term, intrinsic, in the sense of ``objective.'' Costanza~\cite{costanza2004} 
...
Costanza~\cite{costanza2004} makes a compelling case for energy 
...
That is, the goods and services are valued based on market transactions. 
We do so to attempt to bridge the gap 
between neoclassical and ecological economics.\footnote{possibly add a brief discussion 
in a footnote about the differences between the two approaches} 
...
for transactions that occur among economic sectors within the economy. 
...
Following the neoclassical approach, our framework measures ``value-added,'' % chktex 38
the value of the products that is greater than the value of the inputs. 
We denote creation and destruction
of value within a sector using the notion of ``source'' and ``sink.''
In~\ref{fig:basic_value_aggregated}, the open circle, 
...
as in~\ref{fig:basic_value_with_biosphere_flows}.\footnote{As of this printing, 
...
**** Turn this into a URL reference in BibTeX. ****}
