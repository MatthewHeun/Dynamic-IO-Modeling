...
The subjective theory of value based on market prices,
while convenient and prevalent, does not
provide the economy with complete
 information, particularly in the new age of resource depletion. The
...
needed for optimal decision-making in economies situated within a ``full'' earth. 
The UN System of Environmental-Economic Accounting (SEEA)
provides a rigorous methodology to estimate the value 
...
%****BRH: the following paragraph is replaced by the section moved from
%ch. 9, so is commented out.
...
upon inter-sectoral transactions. 
...
As mentioned in the previous section, national accounting focuses on
