...
%%% Begin BRH outline 12.17.13
% 1. indicate we are not doing energy theory of value
% 2. claim we are accepting a "subjective theory of value"  - the source of value-added in the neoclassical
% paradigm
% 3. but our framework allows for others sources of value-added, that are not identified in the NP

% If you are going to count value, you need to have answers to: not only how is value defined but how is value added.
% 1. Value is defined as the market price at the time of a transaction (this is how engineering concept of 
%    control volume or operational boundary comes in to play) -- nothing new
% 2. Value-added -- comes from the list in 5.2.1 -- the first four are not acknowledged
% 3. we are explicitly identifying the sources of value generation and destruction
% 4. From the eqn. we don't care what they are or where they come from -- our 
%    framework is general enough to allow for them, but there is currently
%    no market price data -- there is no transaction so no price
% 5. And, the data cannot be there under the "subjective theory of value" 
% 6. Implication of subjective theory of value is that X11 = X1 (national income and expenditures are equal)
