...
of the assumptions behind the circular flow diagram
...
\noindent{}The neoclassical model does not include these factors.
The assumption is that 
there is no economic value associated with these ``transactions''
that generate value, because no currency is exchanged. 

%%%Begin BRH re-write %%%%
The neoclassical model is based on the idea of ``value-added.'' \ldots\cite{daly1995}
