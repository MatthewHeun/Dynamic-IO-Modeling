...
%****BRH commented this out because this paragraph is
%now in, and better suited to, ch. 5****
%As discussed in previously (see, for example Section~\ref{sec:B_energy}),
...
%arger inputs of materials and energy
