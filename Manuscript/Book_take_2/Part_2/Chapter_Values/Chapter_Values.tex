...
of value\index{accumulation!of economic value} ($X$).
...
\begin{itemize}
	\item{flow of solar energy\index{solar energy}
	into the economy,
...
US BEA\index{Bureau of Economic Analysis}.\footnote{A 
	primer on using the US BEA\index{Bureau of Economic Analysis} 
	industry data can be found 
	on the BEA\index{Bureau of Economic Analysis} website.\cite{Streitwieser:2011aa}}
The  tables needed to estimate dynamic 
value flows and capital accumulation\index{accumulation!of capital} within the economy 
...
from the BEA\index{Bureau of Economic Analysis}.
