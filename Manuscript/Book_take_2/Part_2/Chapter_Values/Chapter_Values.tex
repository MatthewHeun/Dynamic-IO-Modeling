...
%**** BRH: old ch. 9  section placed in between ****
%%%%%%%%%% Theories of value %%%%%%%%%%
...
National economic accounting explicitly focues on measuring value-added, 
but it ignores ''that to which value is being added.'' \cite[p. 453]{Daly1995}
Ignoring the value provided (freely) by the biosphere 
...
Thus, the \emph{subjective} theory of value,
while convenient and prevalent, does not
provide the economy with complete
 information in the new age of resource depletion. In fact,
only recently did the economy come to rely solely on
the subjective theory of value.
%It is also a fluid and
%anthropocentric measure of value.  
%Human wants are malleable and are, in turn, formed within a 
...
and non-economists have searched for a stable, objective, 
...
in favor of the subjective theory of value. (see laTex for a note)
%*** BRH thinks this next section ( between the '****') should be deleted or moved to energy %intensity chapter ***
%And many mainstream economists spurn 
%any analysis aimed at determining~$\boldsymbol{\varepsilon}$, because energy intensity %($\boldsymbol{\varepsilon}$) 
...
%Energy intensity can provide important information for 
%consumption and investment decisions
%in increasingly interconnected economies. 
%****
Despite the considerable drawbacks to the subjective theory of value, it is widely accepted and understood, and
better measures of value are very difficult to implement. 
Thus, in the development of our framework, we use the subjective theory of value, 
where value is based on market prices at the time of transaction, but 
we do so for pragmatic, rather than philosophical, reasons.
However, we believe our framework provides a natural starting place for extending 
existing economic analysis methods to better
guide economies situated within a ``full'' earth. 

The emerging consensus surrounding a system of envrionmental-economic accounting 
provides the necessary extensions to the subjective theory of value to estimate the value 
of flows to and from the biosphere.\footnote{As of this printing, 
	...
	is in its third edition, having been rigorously reviewed and revised 
