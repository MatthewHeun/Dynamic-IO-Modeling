...
and Capital Flow data\footnote{Available from http://bea.gov/iTable/index\_industry.cfm.} could be used to estimate the model as demonstrated in Figure~\ref{fig:Values_data_sources}.
