...
%%%%%%%%%% Value Flows %%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Value stocks and flows}
...
**** MCD - introduce idea of resource quality as discussed in materials and energy chapters ****
...
%**** DOES THIS INCREASE GDP, BAD NEWS IF IT DOES?
% BRH says - no, this has the same effect on the economy
% as the oil embargo -- stag-flation. Ugh! 
% but good news for our story. ****
\footnote{This issue 
