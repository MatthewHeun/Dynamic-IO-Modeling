...
the flows of economic value model with these data
...
of economic values for the economy
...
capital flows, \$795 million in flows of physical capital only, \$15,181 million in flows that
 include R\&D. In the case of the auto industry, and most industries
in general, this difference is an 
order of magnitude.  The larger figure 
includes Intellectual Property assets and is the current 
...
the US measurement of of its capital stock.
...
The Fixed Assets tables were revised retrospectively to use the
new definition. In 2012,  intellectual property accounts for approximately
...
fixed assets (line17)). For comparison, the \$3.4 trillion in
value the nation places on Intellectual Property is
more than half the value the nation
places  in its stock of  Equipment 
 for the same year (\$6.6 trillion (line 18)).~\cite{BEA2013Table}
...
measurement of intangible assets. Does
this reflect an underlying belief
that the country can  invent
its way out of having to face biophysical
limits to the economy? If so, we believe
that this approach will lead to the inability to
fully assess the economic reality and react
appropriately.

The limited, and dwindling, 
...
it is being steered away from assessment
