...
are the Input-Output Use Tables (IO) and the Fixed Asset, non-residential detail. 
 The IO Use table tracks commodities that are made in one industry and then used in another as intermediate inputs ($\dot{R}$, $\dot{S}$). The Use table also tracks the output that
