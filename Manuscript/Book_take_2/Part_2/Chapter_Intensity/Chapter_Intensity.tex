...
% However, as we discussed in Chapter~\ref{chap:acct_for_won},
% resource inputs are only one aspect of production.
...
However, the EI-O method provides an incomplete model of the economy.
