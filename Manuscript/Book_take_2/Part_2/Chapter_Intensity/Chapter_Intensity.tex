...
%%%%%% Below - Imported from Embodied energy chapter %%%%%

Numerous studies have used energy-based, 
input-output methods to model the energetic
cost of goods and services produced by various
economic sectors.\cite{Bullard1975, Herendeen1978, 
Herendeen1973, Wright1974, Herendeen1974, 
Herendeen1974a,  Costanza:1984tq, Lenzen1998, 
Machado2001, Hendrickson2006}
...
The authors note that this estimate is 11\% higher
than obtained via process analysis in a
study by Berry and Fels two years earlier.\cite{Berry:1973vo}
%Costanza and Herendeen (1984) used a slightly
%different approach to analyze the energy intensity
%of economic sectors using national accounts data
%from 1963, 1967 and 1972.
%Their values of the energy consumption due to the
%motor vehicle and equipment manufacturing sector
%were 
%**** MCD - Matt, I think I may need your help
%to interpret the numbers from Costanza. ****
The Economic Input-Output Life Cycle 
Assessment~(EIOLCA) online tool allows
computation of the energy flows through
the economy based on US national accounts\footnote{The 
US national accounts
data has not been updated since 2002.
The issue of national accounts data is discussed in more
detail in Section~\ref{sec:Data}} from 1992,
1997 and 2002~\cite{EIOLCA2014}
based on the framework outlined
by Hendrickson and Lave.\cite{Hendrickson2006}
Using the tool with the 2002 producer price model,
we find that \$1M worth of output
...
%%%%%% Above -  Imported from Embodied energy chapter %%%%%
...
However, very few analysts have done so.
...
in the U.S.\ was 37,275 kW-hr, or $1.27\times10^{8}$ BTU.\cite{Berry:1973vo}
The average cost of a car in 1973 was \$3,650, so the energy intensity
of automobiles in 1973 can be estimated as $3.5\times10^{4}$ BTU/\$.

**** Becky: I obtained the price of the average car in 1973 from

\url{http://www.thecostofliving.com/index.php?id=97\&a=1}, 

possibly not the most reliable source. 
Can you find a better number from a better source? --MKH ****

In 1975, Bullard and Herendeen~\cite[p. 274]{Bullard1975} used the Input-Output method
to estimate the energy cost manufacturing the average car from 1967 data
and obtained a value that was 11 \% greater than Berry and Fels~\cite{Berry:1973vo}.

In 1980, Costanza~\cite{Costanza:1980ww} estimated 
the energy intensity of all economic sectors of the U.S.\ economy
...
\begin{table}
\caption{Selected U.S.\ economic sector energy intensities, 1972.\cite{Costanza:1984tq}}
\begin{center}
\begin{tabular} {r @{\hspace{2em}} l}
	\toprule
...
(which is probably a reasonable assumption for the U.S.), 
steady-state economic conditions with negligible accumulation 
of embodied energy in economic sectors 
(which probably didn't exist in the U.S. in the late 1960s), and 
...
**** Mik: Do you agree? Are we missing something? 
I checked Google Scholar and didn't find anything that looked like 
there were other estimates. --MKH ****
