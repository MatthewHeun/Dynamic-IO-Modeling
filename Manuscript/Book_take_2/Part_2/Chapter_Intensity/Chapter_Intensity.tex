...
was found to be\footnote{The values given here are the average of the 
DIRECT and DEC methods of accounting for energy inputs. 
The percentage difference between the energy intensity averages reported here and 
their DIRECT and DEC counterparts is less than 10\% in all cases.
See Section~\ref{sec:energy_input_vector} for more details.} 
$1.10\times10^{5}$ BTU/\$ (for 1963),
$1.05\times10^{5}$ BTU/\$ (1967), and
$9.81\times10^{4}$ BTU/\$ (1972).

However, the Costanza results~\cite{Costanza:1984tq} 
(and many others in the literature)
assume negligible energy input from society 
...
See Section~\ref{sec:Implications_for_IO} for a complete discussion
of the importance of these assumptions.
