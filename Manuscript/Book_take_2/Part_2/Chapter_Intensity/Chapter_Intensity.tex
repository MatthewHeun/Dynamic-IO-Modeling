...
the energy intensity of \emph{products}. 
Bullard~\cite[p.~268]{Bullard:1978vd} says ``The data and methodologies described in this report 
permit calculation of five types of energy `embodied' 
in a particular goods~[\emph{sic}] or service.''  % chktex 38
In this manuscript, we discuss the energy intensity of \emph{processes}, too,
and we switch between these two meanings of energy intensity.}
...
\noindent{}and $\varepsilon$ is in units of J/\$.\footnote{It is
