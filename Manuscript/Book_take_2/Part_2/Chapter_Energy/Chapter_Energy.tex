...
We note that the gross direct energy production of the energy sector is 
$\dot{E}_{3}$, and the direct energy consumption of the energy sector is 
$\dot{E}_{23} + \dot{E}_{33} + \dot{E}_{43}$. 
The net direct energy production by the energy sector
is given by $\dot{E}_{3} - (\dot{E}_{23} + \dot{E}_{33} + \dot{E}_{43})$.
The energy return on investment ($EROI$) of the energy sector is given by

\begin{equation} \label{eq:C-EROI}
	EROI = \frac{\dot{E}_{3}}{\dot{E}_{23} + \dot{E}_{33} + \dot{E}_{43}}.
\end{equation}
