...
\begin{equation} \label{eq:C-CV_E_dot_1}
	...
	=  \dot{Q}_{21} + \dot{Q}_{31} + \dot{Q}_{41} - \dot{E}_{13} - \dot{E}_{14},
\end{equation}

\begin{equation} \label{eq:C-CV_E_dot_2}
	\frac{\mathrm{d}E_{2}}{\mathrm{d}t} 	 
	= \dot{E}_{32}  + \dot{E}_{42} - \dot{Q}_{21},
\end{equation}
...
\begin{equation} \label{eq:C-CV_E_dot_3}
	...
	= \dot{E}_{13} + \dot{E}_{33} + \dot{E}_{43} - \dot{E}_{3} - \dot{Q}_{31}.
\end{equation}
...
develop \emph{embodied} energy accounting equations for example
economies A--C.
