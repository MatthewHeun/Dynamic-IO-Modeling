...
\begin{equation} \label{eq:dE_1/dt_single_sector}
	\frac{\mathrm{d}E_1}{\mathrm{d}t} = \dot{Q}_{21} - \dot{E}_{12}
\end{equation}
...
accumulating embodied energy\index{embodied energy} in the economy as we shall see 
...
**** Mik: Replace ``Economy'' with ``Energy Sector''. --Matt ****}
\label{fig:B_energy}
\end{figure}
