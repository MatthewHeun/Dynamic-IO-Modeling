...
When energy is ``consumed'' by an economy, 
exergy (work potential) is destroyed.} 
...
Note that $\dot{E}_{2}$ is the gross direct energy production rate
of society. 
For example, firms extract crude oil (a component of $\dot{E}_{12}$) 
and refine it into petroleum products (a component of $\dot{E}_{2}$)
that are consumed by society.
The direct energy consumption of extraction and refining firms 
is a component of $\dot{E}_{22}$.
...
We can extend Example~B, to include an energy sector (3) 
and a goods and services sector (4), thereby obtaining
...
We note that the gross direct energy production of the energy sector (3) is 
$\dot{E}_{3}$, and the direct energy consumption of the energy sector (3) is 
$\dot{E}_{23} + \dot{E}_{33} + \dot{E}_{43}$. 
The net direct energy production by the energy sector (3)
is given by $\dot{E}_{3} - (\dot{E}_{23} + \dot{E}_{33} + \dot{E}_{43})$.
The energy return on investment ($EROI$) of the energy sector (3) is given by

\begin{equation} \label{eq:C-EROI}
	EROI_3 = \frac{\dot{E}_{3}}{\dot{E}_{23} + \dot{E}_{33} + \dot{E}_{43}}.
\end{equation}
