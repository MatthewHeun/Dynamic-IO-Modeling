...
Figure \ref{fig:PERKS_energy_content} shows that for each material flow
of Figure \ref{fig:PERKS_materials}, there is a corresponding direct energy flow.
...
**** Mik: remove the subscript ``E'' from the label in this figure --Matt ****}
