...
****
Need to be more explicit about $\dot{E}$ acting as $\dot{X}$ 
from the point of view of the biosphere.
$\dot{E}$ is the valuable product of the biosphere.
****
...
\begin{equation}
	a_{02} \equiv \frac{\dot{X}_{02}}{\dot{X}_{2}} = \frac{\dot{E}_{02}}{\dot{X}_{2}}.
\end{equation}
