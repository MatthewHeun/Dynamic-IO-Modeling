...
energy input ($\vec{E}_{0}$, $\vec{T}_{1}$)
...
was derived from row vectors and 
is given as\footnote{Equation~\ref{eq:Casler6-converted} is written according
...
The difference between Equations~\ref{eq:Casler6-converted}
and~\ref{eq:Casler6-column-vector} is the use 
of row vectors (for Equation~\ref{eq:Casler6-converted})
and column vectors (for Equation~\ref{eq:Casler6-column-vector}) only.
