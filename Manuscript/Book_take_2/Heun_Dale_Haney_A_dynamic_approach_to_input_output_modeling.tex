...
% Makes the Index, Nomenclature, and Glossary
\makeglossaries{}
...
\glssetwidest[0]{mm} % Indent for the symbol
\glssetwidest[1]{$B_{waste}$mm} % Additional indent for the description
\printglossary[type=nomenclature, style=alttreegroup, nonumberlist=true]
...
\printglossary[type=glossary, style=long, nonumberlist=true]

% Add the index using the glossaries package.
\printglossary[type=index, style=indexstyle]
